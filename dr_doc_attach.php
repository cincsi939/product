...
<script>
	...
	function AddUploadJquery(doc_id){
		...
		var uploadObj = $("#deleteFileUpload"+doc_id).uploadFile({
		 url: "main/multi_upload_file/upload.php?req_id="+req_id+"&doc_id="+doc_id,
		 dragDrop: true,
            	...
            	<table width="100%" align="center" style="font-size:12px;">
                	...
                	<tr>
                    	<td valign="top" width="65%" >
							...
							<div id="startUpload<?php echo $key;?>" class="ajax-file-upload-green" style="margin-left:10px;">เริ่มอัพโหลด</div>
							<div id="deleteFileUpload<?php echo $key;?>" style="display: none;font-size: 10pt;" >แนบไฟล์</div>
						</td>
