...
define("HOMEPAGE_MAIN",'http://61.19.255.90/csg_support/application/usermanager/login.php'); # ค่า pwd สำหรับ connect db   http://csg.dcy.go.th/
...
define('AGE_MOTHER','12'); //ค่า config อายุขั้นต่ำของมารดาที่ใช้ใน ดร.01
