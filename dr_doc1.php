...
<script language="JavaScript">
    ...
    function fncSubmit()
    {
        ...
        {
            alert('กรุณาเลือกจังหวัดที่อยู่ปัจจุบัน');
            document.form1.v810.focus();
            return false;
        }

        if(document.form1.v809.value.trim() == "")
        {
            alert('กรุณาเลือกอำเภอที่อยู่ปัจจุบัน');
            document.form1.v809.focus();
            return false;
        }
        if(document.form1.v808.value.trim() == "")
        {
            alert('กรุณาเลือกตำบลที่อยู่ปัจจุบัน');
            document.form1.v808.focus();
            return false;
        }

        if(document.form1.v377.value == "")
        {
            alert('กรุณาระบุวัน เดือน ปีเกิด');
            document.form1.v377.focus();
            return false;
        }
        ...
        if(document.form1.v33.value == "")
        {
            ...
            document.form1.v33.focus();
            return false;
        }

        if(document.form1.v36.value == "")
        {
            alert('กรุณาระบุรายได้ต่อปี');
            document.form1.v36.focus();
            return false;
        }
...
<div class="container">
    <div class="tab-example">
        <ul class="tabs">
            <li class="tab-link current" data-tab="part_1">ส่วนที่ 1 ข้อมูลหญิงตั้งครรภ์/มารดา (ผู้ลงทะเบียน)</li>
            <?php if($result_consider_result['consider_result'] =='0'){ ?>
                <li class="tab-link" data-tab="part_2">ส่วนที่ 2 สำหรับเจ้าหน้าที่เป็นผู้บันทึก</li>
            <?php } ?>
        </ul>
                    ...
                    <table width="90%" border="0">
                        ...
                        <tr>
                            ...
                            <td height="25" colspan="2">วันเกิด <span class="style1">*</span> <input 	type="text"
                                                                                                        ...
                                                                                                        name="v377"
                                                                                                        id = "v377"
                                                                                                        value="<?php echo ($value[377]==""?"":change_date_format($value[377]));?>">  อายุ
                        ...
                        <tr>
                            ...
                            <td height="25" colspan="2" valign="middle">
                                วันออกบัตร&nbsp;<input 	type="text"
                                                          ...
                                                          name="v701"
                                                          id = "v701"
                                                          value="<?php echo ($value[701]==""?"":change_date_format($value[701]));?>">
                                วันหมดอายุ&nbsp;<input 	type="text"
                                                          class="datepick"
                                                          name="v702"
                                                          id = "v702"
                                                          value="<?php echo ($value[702]==""?"":change_date_format($value[702]));?>">
                            </td>
                        </tr>
                        <tr>
                            <td height="25" align="right"></td>
                        ...
                        <tr>
                            ...
                            <td height="25" colspan="3" valign="middle"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                                    ...
                                    <tr>
                                        ...
                                        <td width="151"><input type="text" value="<?php echo $value[6]; ?>"  name="v6" style="width:50px" id="v6" /></td>
                                ...
                                <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                    ...
                                    <tr>
                                        ...
                                        <td width="151"><input type="text" value="<?php echo $value[806]; ?>"  name="v806" style="width:50px" id="v806" /></td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="1" id="ppDriverTable" class="order-list" width="100%">
                                ...
                                foreach($tbl2 as $row){
                                    ...
                                    <tr>
                                        ...
                                        <td height="50" align="center" valign="top"><span style="cursor:pointer; text-decoration:underline;" onclick="popup('<?php echo $_GET['id'];?>','main/dr_doc1_part2.php?from=edit&eq_id=<?php echo $row['eq_id']; ?>')">แก้ไข</span>&nbsp;/&nbsp;<a id="del" href="main_exc/dr_doc1_del_exc.php?eq_id=<?php echo $row['eq_id']; ?>" OnClick="return chkdel();">ลบ</a></td>
                                    </tr>
                                    <?php
                                }
                                ?>
