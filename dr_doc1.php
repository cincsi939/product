...
<tbody>
         ...
         <td height="25" colspan="2" valign="middle">
         	<?php
				/*$para1 = array(
					...
					'value' => $value[701],
					'showWeek' => false);	
				 $result1 = $ws_client->call('calendar', $para1);//วันออกบัตร
				 $para2 = array(
					'dateFormat' => 'dd/mm/yy',
					'inputname' => 'v702',
					'showicon' => false,
					...
					'value' => $value[702],
					'showWeek' => false);	
				 $result2 = $ws_client->call('calendar', $para2);//วันหมดอายุ*/
			?>
         	วันออกบัตร&nbsp;<span class="style1">*</span><input 	type="text" 
											class="datepick" 
											name="v701" 
                                            id = "v701" 
											value="<?php echo $value[701];?>">
            วันหมดอายุ&nbsp;<span class="style1">*</span><input 	type="text" 
											class="datepick" 
											name="v702" 
                                            id = "v702" 
    ...
    <tr>
      ...
      <td height="25" colspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td width="10%">ชื่อผู้ลงทะเบียน&nbsp;<span class="style1">*</span></td>
          <td width="15%">
          ...
          <td width="25%">ชื่อ    <input name="v1" type="text" value="<?php echo $value[1]; ?>" id="v1" size="20"  /></td>
    ...
    <tr>
      ...
      <table width="471" border="0" cellpadding="1" cellspacing="1">
      	 <tr>
         	<td colspan="4"><u>ที่อยู่ปัจจุบัน</u></td>
         </tr>
         <tr>
          <td width="61" align="left">บ้านเลขที่</td>
...
ปี</td>
    ...
    <tr>
      <td height="25" align="right"></td>
      <td height="25" colspan="2">อาชีพ <span class="style1">*</span><input  name="v33" type="text" value="<?php echo $value[33]; ?>" style="width:90%" id="tCareer"  /></td></td>
      <td align="center">&nbsp;</td>
    </tr>
    <tr>
      <td height="25" align="right"></td>
    ...
    <tr>
     ...
     <tr>
		...
		?>
        <td align="left" colspan="2">ลงทะเบียนหลังคลอด&nbsp;วัน/เดือน/ปี&nbsp;เกิดของเด็ก&nbsp;<input 	type="text" 
											class="datepick" 
											name="v905" 
                                            id = "v905" 
											value="<?php echo $value[905];?>">
			&nbsp;อายุ&nbsp;<input type="text" name="v906" id="v906" value="<?php echo $value[906];?>" style="width:30px;"/>&nbsp;เดือน</td>
    </tr>
	<tr>
	...
	<tr>
    	<td height="25" ></td>
        <td align="left" colspan="3">ชื่อ(นาย) <input type="text" name="v412" id="v412" value="<?php echo $value[412];?>"> นามสกุล <input type="text" name="v413" id="v413" value="<?php echo $value[413];?>"></td>
    </tr>
	<tr>
    	<td height="25" ></td>
        <td align="left" colspan="3">เลขประจำตัวประชาชน <input type="text" name="v414" id="v414" value="<?php echo $value[414];?>" onKeyPress="CheckNum()"> &nbsp;<span  id="idClassCheck2" class="bIdCard">ตรวจสอบ</span> <span  id="random3" class="bIdCard">สุ่มเลขบัตร</span></td>
    </tr>	
    <tr>
	...
	<tr>
        ...
        <td align="left" colspan="2">รับเงินด้วยตนเอง ณ กรมกิจการเด็กและเยาชน หรือ สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัด</td>
    </tr>
    <tr>
    	<td height="25" ></td>
		<?php
        ...
        <td align="left" colspan="2">รับเงินผ่านธนาคารกรุงไทย เลขที่บัญชี&nbsp;<input type="text" name="v921" id="v921" value="<?php echo $value[921];?>"/>สาขา&nbsp;<input type="text" name="v925" id="v925" value="<?php echo $value[925];?>"  style="width:200px;"/></td>
    </tr>
    <tr>
    	<td height="25" ></td>
		<td height="20" ></td>
        <td align="left" colspan="2">ชื่อบัญชี&nbsp;<input type="text" name="v922" id="v922" value="<?php echo $value[922];?>"  style="width:200px;"/>&nbsp;ประเภทบัญชี&nbsp;<input type="text" name="v923" id="v923" value="<?php echo $value[923];?>"  style="width:200px;"/></td>
    </tr>
	<?php
			$check_app = ''; 
			if( $value[0] == '1' ){
    ...
    <tr>
        ...
        <td align="left" colspan="2"><b>ข้าพเจ้าขอรับรองว่าข้อความและเอกสารที่ได้ยื่นนี้เป็นความจริงทุกประการ และเป็นผู้อยู่ในครัวเรือนยากจนและครัวเรือน</b></td>
    </tr>
    <tr>
        <td align="left" colspan="4"  height="25" ><b>ที่เสี่ยงต่อความยากจนที่มีรายได้เฉลี่ยต่ำกว่า 3,000 บาท ต่อคน ต่อเดือน หรือต่ำกว่า 36,000 บาท ต่อคน ต่อปีและไม่เป็นผู้</b></td>
    </tr>
    <tr>
        <td align="left" colspan="4"  height="25" ><b>ได้รับสิทธิ์เงินสงเคราะห์บุตรจากกองทุนประกันสังคม หรือสวัสดิการข้าราชการหรือรัฐวิสาหกิจ และไม่อยู่ในความดูแลของหน่วยงาน</b></td>
    </tr>
	<tr>
        <td align="left" colspan="4"  height="25" ><b>ของรัฐ เช่น บ้านพักเด็กและครอบครัว หรือสถานสงเคราะห์ของรัฐ รวมทั้งข้าพเจ้าไม่เคยได้รับเงินอุดหนุนเพื่อการเลี้ยงดู</b></td>
    </tr>
	<tr>
        <td align="left" colspan="4"  height="25" ><b>เด็กแรกเกิดรายนี้มาก่อน หากข้อความและเอกสารที่ยื่นเรื่องนี้เป็นเท็จ ข้าพเจ้ายินยอมให้ดำเนินการตามกฏหมาย ในการนี้ ข้าพเจ้า</b></td>
    </tr>
	<tr>
        <td align="left" colspan="4"  height="25" ><b>ยินดีรับข้อมูลข่าวสารเพื่อส่งเสริมสุขภาพของแม่และเด็ก ผ่านช่องทางต่างๆ</b></td>
    </tr>
</form>
	<tr>
      <td height="25" align="right">&nbsp;</td>
    ...
    ?>
    <tr>
    	<td align="left" colspan="4"><b><u>ส่วนที่ 2</u> สำหรับเจ้าหน้าที่เป็นผู้บันทึก</b>&nbsp;<img src="../../images_sys/plus.gif" align="absmiddle" onclick="popup('<?php echo $_GET['id'];?>','main/dr_doc1_part2.php?from=add')" style="cursor:pointer;" title="เพิ่มข้อมูลการเกิดของเด็ก"/></td>
    </tr>
     <tr>
	<td colspan="4">
		...
		?>
            <tr>
                ...
                <td height="50" align="center" valign="top"><span style="cursor:pointer; text-decoration:underline;" onclick="popup('<?php echo $_GET['id'];?>','main/dr_doc1_part2.php?from=edit&eq_id=<?php echo $row['eq_id']; ?>')">แก้ไข</span>&nbsp;/&nbsp;<a id="del" href="main_exc/dr_doc1_del_exc.php?id=<?php echo $row['eq_idcard']; ?>&mother_id=<?php echo $_GET['id']; ?>" OnClick="return chkdel();">ลบ</a></td>
          </tr>
         <?php
			}
		 ?>
