            ...
            <tr>
              <td bgcolor="#999999"><table width="100%" border="0" cellspacing="1" cellpadding="3"  id="table0" class="sortable">
                <tr onMouseOver="this.style.cursor='hand'; this.style.background='#EFEFEF';" onMouseOut="this.style.cursor='point'; this.style.background='#FFFFFF';">
                  <td width="3%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>ลำดับ</strong></td>
                  <td width="10%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>รหัสบัตร</strong></td>
                  <td width="10%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>ชื่อ - นามสกุล</strong></td>
                  <td width="12%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>ตำแหน่ง</strong></td>
                  <td width="11%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>สังกัด</strong></td>
                  <td width="11%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>สถานะตรวจข้อมูล<br />
                    เบื้องต้นของคนคีย์</strong></td>
                  <td width="11%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>ความสมบูรณ์ของ<br />
                    การบันทึกข้อมูล</strong></td>
                  <td width="11%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu"><strong>กลุ่มคีย์ข้อมูล</strong></td>
                  <td width="15%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu">&nbsp;</td>
                  <td width="6%" align="center" bgcolor="#CCCCCC"  class="fillcolor_menu">&nbsp;</td>
                </tr>
                <? 
				//$i=0;
				$j=0;
