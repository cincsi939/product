...
WHERE   ( keystaff.sapphireoffice = 0 )  AND (keystaff.status_extra = 'NOR' ) AND monitor_keyin.timeupdate LIKE  '$val%' GROUP BY idcard   ORDER BY keystaff.staffid ASC    " ;

//echo "dbname :: $dbnameuse  ".$str."<hr>";die;
