...
$file_reload = "report_keyin_endproduct_Newv1.php";

echo "<script>alert('ประมวลผลการแบ่งกลุ่ม QC เรียบร้อยแล้ว'); 
window.opener.location='$file_reload?site_id=$site_id&compare_id=$compare_id&s_data1=$s_data1&s_data2=$s_data2&e_data1=$e_data1&e_data2=$e_data2&mm1=$mm1&yy1=$yy1&mm2=$mm2&yy2=$yy2';window.close();
