...
//		}
		...
		echo "<script>top.location.href='".APPURL.APPNAME."pplication/hr3/hr_frame/frame.php';</script>";
		exit;
...
<table width="98%" border=0 align=center cellpadding=5 cellspacing=1 bgcolor="#404040">
  ...
  <tr height=30 bgcolor="#FFFFFF">
    <th colspan="10" bgcolor="#FFFFFF"><font color="#FF0000"><h3>ไม่สามารถบันทึกข้อมูลชุดใหม่ได้เนื่องจาก</h3> <br><?=$alert_msg?></font></th>
  </tr>
  <?
	}//end if($alert_msg != ""){
  ?>
...
WHERE
t3.staffid =  '".$_SESSION[session_staffid]."'  AND (t3.approve <>  '2' OR t3.unlock_idcardkey='1') AND t3.nonactive='0'  $consite $xconv
GROUP BY t1.CZ_ID
