...
<?		
	...
	if($r == "N"){
		...
		if(count($arrc) > 1){
			...
			$temp_date1 = $arrc1[0]."-01";
			$end_date1 = GetdateEnd($temp_date1);
				
				$conv_date = " AND ((t1.start_date <= '".$arrc[0]."-31' AND t1.status_permit='YES' and t1.start_date IS NOT NULL ) or ( t1.status_permit='NO' AND t1.retire_date > '".$arrc[0]."-01' and  t1.start_date between '".$arrc[0]."-01' and '".$end_date."'))";
				
				$conv_date1 = " AND ((t1.start_date <= '".$arrc1[0]."-31' AND t1.status_permit='YES' and t1.start_date IS NOT NULL ))";
		...
		if(count($arrc) > 1){
			...
			$end_date1 = GetdateEnd($temp_date1);
				...
				$conv_date1 = " AND ((t1.start_date <= '".$arrc[0]."-31' AND t1.status_permit='YES' and t1.start_date IS NOT NULL ) or ( t1.status_permit='NO' AND t1.retire_date > '".$arrc[0]."-01' and  t1.start_date between '".$arrc[0]."-01' and '".$end_date."'))";
				
				$conv_date = " AND ((t1.start_date <= '".$arrc1[0]."-31' AND t1.status_permit='YES' and t1.start_date IS NOT NULL ))";
	...
	$sqlc1 = "SELECT t1.staffid FROM keystaff as t1   WHERE t1.period_time='am' AND t1.status_extra='NOR'  and t1.sapphireoffice='0' $con1 $con_idcard 
	...
	$conv_date $con1_1	$con_instaff   ORDER BY t1.staffname ASC $xlimit";
	//echo $sql_staff;
