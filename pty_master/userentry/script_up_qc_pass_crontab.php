...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td colspan="2" align="left" bgcolor="#EFEFFF"><strong>เลือกวันที่จะรับรองข้อมูล</strong></td>
        </tr>
      <tr>
        <td width="10%" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="90%" bgcolor="#FFFFFF"><INPUT name="date_up" id="date_up" onFocus="blur();" value="<?=$date_up?>" size="15">
              <INPUT name="button" id="button0" type="button"  onClick="popUpCalendar(this, post.date_up, 'dd/mm/yyyy')"value="วัน เดือน ปี" <?=$dis1?>></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF"><label>
          <input type="submit" name="Submit" value="ประมวลผลรับรองข้อมูล">
				...
				if($rs1[idcard] != ""){
					if(check_salary($rs1[siteid],$rs1[idcard]) > 0){
							...
							$k++;
								...
								echo $sql_up."<br>";
								@mysql_db_query(DB_USERENTRY,$sql_up);
...
//						} //end 	if($rs1[ticketid] != $tem_ticketid){
		...
		echo "<h3><font color='red'>สิ้นสุดกระบวนการรับรองข้อมูล รายการทั้งหมด $k  รายการ</font></h3>";
	} //end if($aciton == "run1"){
?>
</BODY>
</HTML>
