...
<?php
if($_GET['select'] == '1'){
  echo "<script>opener.document.getElementById('salary_id_add').value = '".$_GET['salary_id']."' ;opener.document.getElementById('noorder_add').value = '".$_GET['remark']."' ;opener.document.getElementById('remark_add').value = '".$_GET['remark']."' ;opener.document.getElementById('date_command').value = '".$_GET['date_command']."' ;opener.document.getElementById('date_start').value = '".$_GET['date_start']."' ; window.close();</script>";
}
