...
var TableGear = new Class({
			...
			cells.each(function(cell, colIndex){
				...
				if(cell.hasClass("editable")){
					...
					input.addEvent("blur", function(event){
						...
						if(tridentSelect) this.addEditJob(input, span, cell, colIndex);
					...
					input.addEvent("change", function(event){
						...
						this.addEditJob(input, span, cell, colIndex);
	...
	addEditJob: function(input, span, cell, colIndex){
	...
	onComplete: function(response){
		...
		var affected = json.action == "delete" ? this.currentJob.row : this.currentJob.cell;
		affected.removeClass("loading");
