...
$str = "SELECT keystaff.staffid, keystaff.prename, keystaff.staffname, keystaff.staffsurname, monitor_keyin.idcard, monitor_keyin.timeupdate
 FROM keystaff Inner Join monitor_keyin ON monitor_keyin.staffid = keystaff.staffid 
WHERE ( keystaff.sapphireoffice = 0 ) AND (keystaff.status_extra = 'NOR' ) and keystaff.period_time='pm' AND monitor_keyin.timeupdate LIKE '$val%'
 GROUP BY idcard ORDER BY keystaff.staffid ASC ";

//echo $str."<hr>";die;and  (keystaff.staffid='10758' or keystaff.staffid='10685') 10734 
