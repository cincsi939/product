<?php
	...
	$dbTempCheckData="edubkk_checklist";
	
	$tblMonitorKey="view_monitor_key";
	
	$url_base="https://master.cmss-otcsc.com/competency_master/";
	$partPdf="../../../../edubkk_kp7file/";
	$partPdfElec="http://202.129.35.120/edubkk_master/application/hr3/hr_report/kp7_search.php?tmppass=123456&tmpuser=&";
	$partImgPdf="https://master.cmss-otcsc.com/competency_master/images_sys/gnome-mime-application-pdf.png";
	$partImgPdfElec="https://master.cmss-otcsc.com/edubkk_master/application/hr3/hr_report/bimg/pdf.gif";
