...
$strSql=" SELECT tbl_checklist_kp7.idcard AS idcard, 
	...
	if(edubkk_userentry.tbl_assign_key.idcard IS NOT NULL, if(COUNT(edubkk_userentry.tbl_assign_key.idcard)='1' AND tbl_checklist_kp7.profile_id=edubkk_userentry.tbl_assign_key.profile_id,'kp7_new','kp7_update'), 'kp7_new') AS status_dockey, 
	if(edubkk_userentry.tbl_assign_key.idcard IS NULL, '0', '1') AS status_assign, 
	if(edubkk_userentry.tbl_assign_key.approve='2', '1', '0') AS status_approve   
