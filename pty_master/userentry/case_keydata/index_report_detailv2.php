...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><a href="#" class="screenshot" rel="<?=$filename?>"><img src="<?=$filename?>" width="40" height="50" border="0"></a></td>
  </tr>
  <?
  ...
  <tr>
    ...
    <thead>  
      ...
      <tr>
        ...
        <th width="15%" align="center" bgcolor="#CCCCCC"><strong>วันเวลสสิ้นสุดบันทึก</strong></th>
