...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr>
    <td colspan="2" align="center" bgcolor="#A5B2CE"><strong><a href="?xyymm=<?=$yymm?>&xtype=prev"><img src="../../images_sys/arrow_left_blue.png" width="16" height="16" title="คลิ๊กเพื่อดูข้อมูลสถิติเดือนก่อนหน้านี้" border="0"></a>&nbsp;รายงานสถิติการบันทึกข้อมูลประจำเดือน 
          <?=$monthname[intval($arrd[1])]?> พ.ศ. <? echo $arrd[0]+543;?>&nbsp;<a href="?xyymm=<?=$yymm?>&xtype=net"><img src="../../images_sys/arrow_right_blue.png" width="16" height="16" title="คลิ๊กเพื่อดูข้อมูลสถิติเดือนถัดไป" border="0"></a></strong></td>
  </tr>
  <tr>
