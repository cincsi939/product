...
$sql_maxtime = "SELECT max(timeupdate) as maxtime FROM `view_person_executive`";
$result_maxtime = mysql_db_query($dbnamemaster,$sql_maxtime) or die(mysql_error()."".__LINE__);
$rsmax = mysql_fetch_assoc($result_maxtime);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" bgcolor="#FFFFFF"><a href="CCreport_person_executive.php" target="_blank">คลิ๊กเพื่อประมวลผล</a> </td>
  </tr>
  <tr>
    <td><table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" bgcolor="#666666"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          ...
          <tr>
            <td width="34%" align="center" bgcolor="#CCCCCC"><strong>กลุ่มบุคลากรฯ</strong></td>
  ...
  <tr>
    <td align="right"><em><strong>&nbsp;ประมวลผลข้อมูลล่าสุด ณ วันที่ <? echo ShowThaiDateTime($rsmax[maxtime])." น."; ?>&nbsp; จากจำนวนข้าราชการครูและบุคลากรทางการศึกษาทั้งหมด  <?
    	$sql_all = "SELECT COUNT(CZ_ID) AS numall FROM view_general WHERE siteid NOT LIKE '99%'";
		$result_all = mysql_db_query($dbnamemaster,$sql_all) or die(mysql_error()."".__LINE__);
		$rsall = mysql_fetch_assoc($result_all);
		echo number_format($rsall[numall]) ." คน";
	?>
&nbsp;&nbsp;&nbsp; </strong>    </em></td>
  </tr>
</table>
  ...
  <tr>
    <td bgcolor="#000000"><table width="100%" border="1" cellspacing="1" cellpadding="3" class="tbl3">
      <tr>
        ...
        <td colspan="12" align="center" bgcolor="#CCCCCC"><strong>บุคลากรในสำนักงานเขตพื้นที่การศึกษา</strong></td>
        <td colspan="6" align="center" bgcolor="#CCCCCC"><strong>บุคลากรในสถานศึกษา</strong></td>
        </tr>
      <tr>
