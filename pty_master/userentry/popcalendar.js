    ...
    */
	...
	function closeCalendar() {
		...
		// ??????????????????????????
		if(document.forms[0].act_num){
		countdays(document.forms[0].start_date.value,document.forms[0].finish_date.value)
		}
		if(document.forms[0].day_count){
			countdays_p(document.forms[0].start_date.value,document.forms[0].end_date.value)
		}
		if(document.forms[0].day_count_req){
				countdays_req(document.forms[0].start_date.value,document.forms[0].end_date.value);
		}
		if(callback!=""){
			eval(callback);
			}
