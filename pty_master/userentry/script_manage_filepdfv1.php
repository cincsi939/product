...
if($action == "copyfile"){
	...
	$path_dest = "../../../edubkk_kp7file/$xsecid/";
...
if($action == "getdata"){
	####  sript log pdf
	if($type == "pdf"){
	$file_pdf = read_file_folder($xsiteid);
...
//							}
	...
	echo "<script>alert('script เก็บ log บันทึกข้อมูลเรียบร้อยแล้ว  $j  รายการ'); location.href='script_manage_filepdfv1.php?action=';</script>";
	}// end if($type == "pdf"){
	#### end sript log pdf
#####  ประมวลผลทั้งหมด
	if($type == "pdfall"){
        ...
        <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
              ...
              <?
              	$sql_a = "SELECT ".DB_USERENTRY.".keystaff.prename, ".DB_USERENTRY.".keystaff.staffname, ".DB_USERENTRY.".keystaff.staffsurname,
 ".DB_CHECKLIST.".tbl_checklist_log.time_update
FROM
 ".DB_CHECKLIST.".tbl_checklist_log
Inner Join ".DB_USERENTRY.".keystaff ON  ".DB_CHECKLIST.".tbl_checklist_log.user_update = ".DB_USERENTRY.".keystaff.staffid
WHERE
