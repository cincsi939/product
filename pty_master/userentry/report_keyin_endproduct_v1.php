...
where  t2.keyin_group='2'  $conid $con1
group by  t2.keyin_group";
...
stat_user_keyin AS t2
 ON t1.staffid = t2.staffid
where  t2.keyin_group='3' $conid $con1
group by 
t2.rpoint";
//echo $sql."<hr>";
	$result = mysql_db_query($dbnameuse,$sql) or die(mysql_error()."$sql<BR>LINE::".__LINE__);
	while($rs = mysql_fetch_assoc($result)){
	$arr[$rs[rpoint]]['numstaff'] = $rs[numstaff];	
        ...
        <?
        	...
        	if($compare_id == "1"){
				...
				$arr_n1 = GetDataGroupN($site_id,$compare_id,$date3,$date4); // กลุ่ม N
					...
					$sub_h1 = "เดือน  ".$monthname[$mm1]." พ.ศ. ".$yy1;
					$sub_h2 = "เดือน  ".$monthname[$mm2]." พ.ศ. ".$yy2;
		             ...
		             <tr>
		               <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		                 ...
		                 <tr>
		                   ...
		                   <td width="10%" align="center" bgcolor="#A5B2CE"><strong>ผลผลิตรวม</strong></td>
		                   <td width="10%" align="center" bgcolor="#A5B2CE"><strong>ผลผลิตต่อคน</strong></td>
		                   <td width="8%" align="center" bgcolor="#A5B2CE"><strong>จำนวน (คน)</strong></td>
		                   <td width="7%" align="center" bgcolor="#A5B2CE"><strong>(+/-)</strong></td>
		                   <td width="8%" align="center" bgcolor="#A5B2CE"><strong>ผลผลิตรวม</strong></td>
		                   <td width="7%" align="center" bgcolor="#A5B2CE"><strong>(+/-)</strong></td>
		                   <td width="8%" align="center" bgcolor="#A5B2CE"><strong>ผลผลิตต่อคน</strong></td>
		                   <td width="7%" align="center" bgcolor="#A5B2CE"><strong>(+/-)</strong></td>
		                   </tr>
                           <?
							...
							while($rs = mysql_fetch_assoc($result)){
								...
								if($rs[groupreport_id] == "1"){
										...
										$numpoint_val1 = $arr_e['numpoint'];// จำนวนพนักงานทั้งหมด1
										$numpoint_val2 = $arr_e1['numpoint'];
										if($staff_val1 > 0){
										...
										$numpoint_val1 = $arr_l['numpoint'];// จำนวนพนักงานทั้งหมด1
										$numpoint_val2 = $arr_l1['numpoint'];
										if($staff_val1 > 0){
											$numpoint_avg1 = $numpoint_val1/$staff_val1;
										}
										if($staff_val2 > 0){
										...
										$numpoint_val1 = $arr_n[$rs[r_point]]['numpoint'];// จำนวนพนักงานทั้งหมด1
										$numpoint_val2 = $arr_n1[$rs[r_point]]['numpoint'];
										if($staff_val1 > 0){
											$numpoint_avg1 = $numpoint_val1/$staff_val1;
										}// end if($staff_val1 > 0){
										if($staff_val2 > 0){
		                 ...
		                 <tr bgcolor="<?=$bg?>">
		                   ...
		                   <td align="center"><?=number_format($staff_val1)?></td>
		                   <td align="center"><?=number_format($numpoint_val1,2)?></td>
		                   <td align="center"><?=number_format($numpoint_avg1,2)?></td>
		                   <td align="center"><?=number_format($staff_val2)?></td>
		                   <td align="center"><? if($staff_pd < 0){ echo "<font color=\"#CC0000\">".number_format($staff_pd)."</font>";}else{ echo number_format($staff_pd); }?></td>
