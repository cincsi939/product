...
function SaveLogKey($log_id,$menu_id,$val_before,$val_after,$timestart,$timeend){
	global $dbnameuse;
	$sql = "INSERT INTO tbl_assign_edit_log_detail_key SET log_detail_id='$log_id',menu_id='$menu_id',val_before='$val_before',val_after='$val_after',timestart='$timestart',timeend='$timeend' ";	
