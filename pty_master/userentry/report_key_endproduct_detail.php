...
<?		
	...
	if(count($arrc) > 1){
			...
			$conid_staff = " AND ((t1.start_date <= '".$date1."-01' AND t1.status_permit='YES' and t1.start_date IS NOT NULL ) or ( t1.status_permit='NO' AND t1.retire_date > '".$date1."-01' and  t1.start_date between '".$date1."-01' and '".$date1."-31'))";
	...
	$conv_date $con1_1	 GROUP BY t1.staffid  ORDER BY t1.staffname ASC ";
	//echo $sql_staff;
