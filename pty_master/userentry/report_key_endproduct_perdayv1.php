...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr>
    <td colspan="2" align="center" bgcolor="#A5B2CE"><strong>รายงานสถิติการบันทึกข้อมูลประจำเดือน 
          <?=$monthname[intval($arrd[1])]?> พ.ศ. <? echo $arrd[0]+543;?></strong></td>
  </tr>
  <tr>
    <td width="70%" align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        ...
        <td width="12%" rowspan="2" align="center" bgcolor="#A5B2CE"><strong>วันที่</strong></td>
        <td width="9%" rowspan="2" align="center" bgcolor="#A5B2CE"><strong>เป้าหมาย<br>
          ผลผลิต(ชุด)</strong></td>
        <td width="10%" rowspan="2" align="center" bgcolor="#A5B2CE"><strong>จำนวนผลผลิต<br>
          ทั้งหมด(ชุด)</strong></td>
        <td width="10%" rowspan="2" align="center" bgcolor="#A5B2CE"><strong>ผลต่าง <br>
          (ชุด)</strong></td>
      ...
      <tr>
        <td width="9%" align="center" bgcolor="#A5B2CE"><strong>ชุด</strong></td>
        <td width="9%" align="center" bgcolor="#A5B2CE"><strong>ร้อยละ</strong></td>
        <td width="9%" align="center" bgcolor="#A5B2CE"><strong>ชุด</strong></td>
        <td width="9%" align="center" bgcolor="#A5B2CE"><strong>ร้อยละ</strong></td>
        <td width="9%" align="center" bgcolor="#A5B2CE"><strong>ชุด</strong></td>
        <td width="10%" align="center" bgcolor="#A5B2CE"><strong>ร้อยละ</strong></td>
      </tr>
        <?
		if(count($arrdata) > 0){
			$i=0;
