            ...
            <tr>
              <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
                <tr>
                  ...
                  <td width="13%" align="center" bgcolor="#A5B2CE"><strong>บัตรประชาชน</strong></td>
                  <td width="11%" align="center" bgcolor="#A5B2CE"><strong>ชื่อ-นามสกุล</strong></td>
                  <td width="14%" align="center" bgcolor="#A5B2CE"><strong>ตำแหน่ง</strong></td>
                  <td width="17%" align="center" bgcolor="#A5B2CE"><strong>โรงเรียน/หน่วยงาน</strong></td>
                  <td width="13%" align="center" bgcolor="#A5B2CE"><strong>เวลาเริ่มบันทึก</strong></td>
				  ...
				  <? } //end  if ($_SESSION[session_sapphire] == 1 ){?>
                  <td width="5%" align="center" bgcolor="#A5B2CE"> <!--<INPUT TYPE="checkbox" NAME="chk" ONCLICK="checkAll(this.form.list,this.checked)" > 
...
//				$ch_num = @mysql_num_rows($result1);
			...
			foreach($xarr_prove as $xkey => $xval){
				 ...
				 if(check_data_approve($xkey,$xarr_siteid[$xkey]) != ""){
				...
				<? if($_SESSION[session_sapphire] == "1"){ 
				 ...
				 ?>
                <tr>
                  <td colspan="9" align="right" bgcolor="#FFFFFF"><strong><span class="style5">ค่าใช้จ่ายสุทธิ</span> = <span class="style5">ค่าใช้จ่ายที่บันทึกได้</span> - <span class="style5">ค่าคะแนนลบ</span>:</strong></td>
				...
				<? if($pay_money > 1000){?>
                <tr>
                  <td colspan="9" align="right" bgcolor="#FFFFFF"><strong>หักภาษี 3 % : </strong></td>
                  <td align="right" bgcolor="#FFFFFF"><strong>
                ...
                <tr>
                  <td colspan="9" align="right" bgcolor="#FFFFFF"><strong><span class="style5">ค่าใช้จ่ายสุทธิ</span>:</strong></td>
