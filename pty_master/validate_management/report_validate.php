    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr>
            <td colspan="4" align="left" bgcolor="#A3B2CC"><strong>ค้นหาเจ้าหน้าที่บันทึกข้อมูล</strong></td>
            </tr>
          <tr>
            <td width="14%" align="right" bgcolor="#A3B2CC"><strong>ชื่อ : </strong></td>
            <td width="24%" align="left" bgcolor="#A3B2CC"><label>
              <input name="key_name" type="text" id="key_name" size="25" value="<?=$key_name?>">
            </label></td>
            <td width="11%" align="right" bgcolor="#A3B2CC"><strong>นามสกุล :</strong></td>
            <td width="51%" align="left" bgcolor="#A3B2CC"><label>
              <input name="key_surname" type="text" id="key_surname" size="25" value="<?=$key_surname?>">
            </label></td>
          </tr>
<!--          <tr>
            <td align="right" bgcolor="#A3B2CC"><strong>ตั้งแต่วันที่ : </strong></td>
            <td align="left" bgcolor="#A3B2CC"><INPUT name="kstartdate" onFocus="blur();" value="<?//=$kstartdate?>" size="15" readOnly>
            <INPUT name="button" type="button"  onClick="popUpCalendar(this, form1.kstartdate, 'dd/mm/yyyy')"value="วันเดือนปี"></td>
            <td align="right" bgcolor="#A3B2CC"><strong>ถึงวันที่ : </strong></td>
            <td align="left" bgcolor="#A3B2CC"><INPUT name="kenddate" onFocus="blur();" value="<?//=$kenddate?>" size="15" readOnly>
            <INPUT name="button" type="button"  onClick="popUpCalendar(this, form1.kenddate, 'dd/mm/yyyy')"value="วันเดือนปี"></td>
          </tr>-->
          <tr>
    ...
    <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      ...
      <?
			...
			if($key_surname != ""){ $conv .= " AND staffsurname LIKE '%$key_surname%'";}
      		$sql = "SELECT * FROM keystaff WHERE sapphireoffice='0' $conv"; // พนักงานจ้างชั่วคราวเท่านั้น
