...
<? } ######### END   }else{ if  ($lv == 1 ){   ?>    	 
 ...
 <tr>
    ...
    <?=get_dateThai(date("Y-m-d"));?>&nbsp;&nbsp;&nbsp;</strong></td>
  </tr>
   <tr>
  ...
  <tr>
	...
	<thead> 
      <tr>
        ...
        <? if($lv == "1"){?>
        <th width="7%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong>รหัส<br>
          หน่วยงาน</strong></th>
        <? } //end ?>
        <th width="17%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong><?=$xtitle?></strong></th>
        <th width="6%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong></strong>อัตราจริง<br>
          รวม(คน)</th>
        <th width="7%" rowspan="2" align="center" bgcolor="#A8B9FF"><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
          <HTML>
        ...
        <th width="7%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong>ค้างรับ<br>
          (คน)</strong></th>
        <td colspan="5" align="center" bgcolor="#A8B9FF"><strong>ผลการตรวจสอบเอกสาร</strong></td>
...
$result = mysql_db_query($dbname_temp,$sql);
      ...
      <tr bgcolor="<?=$bg?>">
        ...
        <td align="center"><?=number_format($count_norecive)?></td>
        <td align="center"><?=number_format($count_n)?></td>
        <td align="center"><? if($count_y > 0){ echo "<a href='$link_y' target='_blank'>".number_format($count_y)."</a>";}else{ echo "0";}  number_format($count_y);?></td>
        <td align="center"><?=number_format($count_idfalse)?></td>
