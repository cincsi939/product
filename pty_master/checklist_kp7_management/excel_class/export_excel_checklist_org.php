...
$worksheet1->write($line2, 15," ", $h_BTM);
$worksheet1->write($line2, 16," ", $h_BTM);


$worksheet1->write($line3, 17,"หมายเหตุ", $h_BNK);
$worksheet1->write($line3, 18,"สีชมพู คือเอกสารไม่สมบูรณ์", $h_BNK_Pink);
$worksheet1->write($line4,18,"สีฟ้า คือ เอกสารขาดปกประกอบ", $h_BNK_Blue);
$worksheet1->write($line5,18,"สีเหลือง คือ เอกสารเลขบัตรไม่สมบูรณ์", $h_BNK_orange);
$worksheet1->write($line6,18,"สีเทา คือ เลขบัตรไม่สมบูรณ์จาก pobec และจำนวนที่ค้างรับเอกสาร", $h_BNK_grey);
