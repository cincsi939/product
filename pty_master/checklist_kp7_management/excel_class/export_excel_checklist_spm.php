...
$worksheet1->set_column("O:O", 15);//เลขบัตรที่ถูกต้อง
...
$worksheet1->write($line3, 13,"หมายเหตุ", $h_BNK);
$worksheet1->write($line3, 14,"สีชมพู คือเอกสารไม่สมบูรณ์", $h_BNK_Pink);
$worksheet1->write($line4,14,"สีฟ้า คือ เอกสารขาดปกประกอบ", $h_BNK_Blue);
$worksheet1->write($line5,14,"สีเหลือง คือ เอกสารเลขบัตรไม่สมบูรณ์", $h_BNK_orange);
$worksheet1->write($line6,14,"สีเทา คือ เลขบัตรไม่สมบูรณ์จาก pobec และจำนวนที่ค้างรับเอกสาร", $h_BNK_grey);
$worksheet1->write($line7,14,"สีน้ำตาล คือ เอกสารค้างรับ", $h_BNK_grey1);
######  start data
