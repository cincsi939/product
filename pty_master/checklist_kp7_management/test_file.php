...
$xfile = "xxxxxxxxxxxx.pdf";

echo "การเข้ารหัส :: ".CheckFileEncrypt($xfile)."<br>";
echo "ไฟล์เสีย :: ".CheckFileError($xfile)."<br>";
echo "xrefer :: ".CheckFilePDF($xfile)."<br>";
echo XCountPagePdf($xfile);
die;
