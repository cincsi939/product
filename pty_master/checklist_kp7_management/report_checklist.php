...
<?
	...
	$arr1 = show_val_exsum($lv,$_GET['xsiteid'],$schoolid,$profile_id);
			...
			$numQL_all = $arr1['NumQL']; // ได้รับเอกสารจากหน่วยงาน (รวม)
			...
			$numsite = CountAreaProfile($profile_id); // จำนวนหน่วยงานการศึกษาในโฟรไฟล์นั้น
   ...
   <table width="650" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
         <tr>
           <td colspan="5" align="center" bgcolor="#abc8e2"><strong>รายงานผลการตรวจสอบเอกสารสำเนา กพ.7 ต้นฉบับ <br>
         ...
         <tr>
           ...
           <td width="11%" align="center" bgcolor="#FFFFFF"><strong>หน่วยงาน</strong></td>
         </tr>
         <tr>
           <td align="left" bgcolor="#FFFFFF"><strong>ได้รับเอกสารจากหน่วยงาน (รวม)</strong></td>
     ...
     <table width="700" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
       <tr>
         <td bgcolor="#000000"><table width="100%" border="0" cellpadding="3" cellspacing="1" bordercolor="#000000">
           <tr>
             <td colspan="7" align="center" bgcolor="#abc8e2"><strong>รายงานผลการตรวจสอบเอกสารสำเนา กพ.7 ต้นฉบับ <br>
ข้าราชการครูและบุคลากรทางการศึกษา (
    ...
    <? show_area($_GET['xsiteid']) ?></strong></td>
           ...
           <tr>
             <td colspan="5" align="left" bgcolor="#abc8e2"><strong>เข้าพื้นที่ดำเนินการตั้งแต่วันที่  
               <?=$thtimemin?> 
               ถึงวันที่  
               <?=$thtimemax?>
             </strong></td>
             <td colspan="2" align="center" bgcolor="#abc8e2"><strong>จำนวนเอกสาร<br>
           ...
           <tr>
             <td height="22" align="left" bgcolor="#FFFFFF"><strong>ได้รับเอกสารจากหน่วยงาน (รวม)</strong></td>
             <td align="center" bgcolor="#EEEEEE"><strong>
...
<? } ######### END   }else{ if  ($lv == 1 ){   ?>    	 
 ...
 <tr>
   ...
   <tr>
    <td align="left">&nbsp;<strong><? if($lv == 1){ echo "<a href='?lv=&profile_id=$profile_id'>แสดงข้อมูลภาพรวม</a> :: ".show_area($_GET['xsiteid']);}?></strong></td>
  </tr>
  <? if($lv == ""){ $xtitle = "สำนักงานหน่วยงานการศึกษา"; $xcolh = "10"; $xcolf = "2";}else{ $xtitle = "หน่วยงาน"; $xcolh = "11"; $xcolf = "3";}
  
  ?>
  <tr>
    <td align="center" valign="middle" bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td width="5%" rowspan="2" align="center" bgcolor="#abc8e2"><strong>ลำดับ<br>
        </strong></td>
    
        <td width="18%" rowspan="2" align="center" bgcolor="#abc8e2"><strong><strong>หน่วยงาน</strong></td>
        <td width="6%" rowspan="2" align="center" bgcolor="#abc8e2"><strong>อัตราจริง<br>
          รวม(คน)</strong></td>
        <td width="6%" rowspan="2" align="center" bgcolor="#abc8e2">
          <p><strong>ได้รับ<br>
            เอกสาร<br>
            (คน)</strong></p></td>
        <td colspan="2" align="center" bgcolor="#abc8e2"><strong>ค้างรับ (คน)</strong></td>
        <td colspan="5" align="center" bgcolor="#abc8e2"><strong>ผลการตรวจสอบเอกสาร</strong></td>
        <td width="6%" rowspan="2" align="center" bgcolor="#abc8e2"><strong>จำนวน<br>
          (แผ่น)</strong></td>
...
สมบูรณ์</strong></td>
        <td width="7%" align="center" bgcolor="#abc8e2"><strong>
          <?=TEXT_IDCARD?>
          <br>
ไม่สมบูรณ์</strong></td>
        <td width="8%" align="center" bgcolor="#abc8e2"><strong>อยู่ระหว่าง<br>
          ตรวจสอบ</strong></td>
        <td width="7%" align="center" bgcolor="#abc8e2"><strong>สมบูรณ์</strong></td>
        <td width="7%" align="center" bgcolor="#abc8e2"><strong>
          <?=TEXT_IDCARD?>
          <br>
          ไม่สมบูรณ์</strong></td>
        <td width="7%" align="center" bgcolor="#abc8e2"><strong>ขาดเอกสาร<br>
          ประกอบ</strong></td>
        <td width="7%" align="center" bgcolor="#abc8e2"><strong>ไม่สม<br>
          บูรณ์</strong></td>
      </tr> 
...
";
	...
	# update temp_order school ให้หน่วยงานการศึกษาไปอยู่ข้างบนสุด
	$sql_uptemp =  "UPDATE temp_order_school SET orderby='0' WHERE schoolid='".$_GET['xsiteid']."'";
	mysql_db_query($dbname_temp,$sql_uptemp);
	
	$arrnum = array();
	$arrnum = QueryDataList($_GET['xsiteid'],$profile_id); // ข้อมูลจำนวนของแต่ละหน่วยงาน
$sql = "SELECT
...
echo ($_GET['debug'] == "ON")?"<hr>$sql</hr>":"";		
		while($rs = mysql_fetch_assoc($result)){
			 if ($i++ %  2){ $bg = "#F0F0F0";}else{$bg = "#FFFFFF";}
			  ...
			  if($lv == ""){
				  ...
				  $count_QL =$arrN[$id_org]['NumQL']; // ได้รับเอกสารจากหน่วยงาน (รวม)
			...
			if($arr_datanull[$rs[secid]] > 0){
				...
				$link_datanull = "";	
				 ...
				 // echo "<pre>";
				  ...
				  $count_QL =$arrnum[$id_org]['NumQL']; // ได้รับเอกสารจากหน่วยงาน (รวม)
      ...
      <tr class="txthead">
        <td colspan="2" align="center" bgcolor="#abc8e2"><strong>รวม</strong></td>
