...
$xfile = "../../../".PATH_KP7_FILE."/5001/1411300030474.pdf";
$temp_page = CountPageSystem($xfile);
echo "$temp_page";
die;
...
if($action == "copyfile"){
	...
	echo "<script>alert('คัดลอกไฟล์ได้  $j  รายการไม่สามารถคัดลอกได้ $k รายการ'); location.href='script_manage_filepdf.php?action=';</script>";	
