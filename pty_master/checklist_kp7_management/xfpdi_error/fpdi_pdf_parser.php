...
class fpdi_pdf_parser extends pdf_parser {
    ...
    function fpdi_pdf_parser($filename, &$fpdi) {
       ...
       $xreturn =  parent::pdf_parser($filename);
	   $this->xvalue = $xreturn;
    }
...
//        $this->fpdi =& $fpdi;
//		
//       $xreturn =  parent::xpdf_parser($filename);
//	   $this->xvalue_x = $xreturn;
//    }
...
class xfpdi_pdf_parser extends pdf_parser {
...
//    }
	...
	function xfpdi_pdf_parser($filename, &$fpdi) {
        $this->fpdi =& $fpdi;
...
#################################################################################  class ä¿Åì·ÕèÁÕ»Ñ­ËÒµéÍ§ repare#############

class fpdi_pdf_parser_error extends pdf_parser {
...
//    }
	...
	function fpdi_pdf_parser_error($filename, &$fpdi) {
        $this->fpdi =& $fpdi;
		
       $xreturn =  parent::pdf_parser_error($filename);
	   $this->xvaluex3 = $xreturn;
    }
