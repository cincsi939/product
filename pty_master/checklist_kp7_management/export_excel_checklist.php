...
t2.office,
t2.moiareaid,
if(t1.status_file='0' and status_id_false='0',1,if(t1.status_file='1' and status_id_false='0' and (mainpage='0' or mainpage='' or mainpage IS NULL),2,if(status_id_false='1',3,0) ) ) as ty,
