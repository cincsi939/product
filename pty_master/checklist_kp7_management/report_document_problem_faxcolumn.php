...
ราชการ<br>
  ...
  <? 
	  ...
	  ?>
      <tr><td>		<a href="?type_doc=<?=$type_doc?>&typeproblem=<?=$typeproblem?>&schoolid=<?=$schoolid?>&problem_status_id=<?=$problem_status_id?>&xlv=<?=$_GET['xlv']?>&xsiteid=<?=$_GET['xsiteid']?>&profile_id=<?=$_GET['profile_id']?>&school_type=">แสดงทั้งหมด</a> |<a href="?type_doc=<?=$type_doc?>&typeproblem=<?=$typeproblem?>&schoolid=<?=$schoolid?>&problem_status_id=<?=$problem_status_id?>&xlv=<?=$_GET['xlv']?>&xsiteid=<?=$_GET['xsiteid']?>&profile_id=<?=$_GET['profile_id']?>&school_type=0&txt_title=(สังกัด สพป.)">สังกัด สพป.</a> |<a href="?type_doc=<?=$type_doc?>&typeproblem=<?=$typeproblem?>&schoolid=<?=$schoolid?>&problem_status_id=<?=$problem_status_id?>&xlv=<?=$_GET['xlv']?>&xsiteid=<?=$_GET['xsiteid']?>&profile_id=<?=$_GET['profile_id']?>&school_type=1&txt_title=(สังกัด สพม.)"> สังกัด สพม.</a></td></tr>
  <tr>
...
ราชการ<br>
    ...
    <tr><td align="left"><a href="?type_doc=<?=$type_doc?>&profile_id=<?=$profile_id?>&xsiteid=<?=$xsiteid?>&xlv=<?=$xlv?>&typeproblem=<?=$typeproblem?>&schoolid=&problem_status_id=<?=$problem_status_id?>&school_type=<?=$school_type?>&txt_title=<?=$txt_title?>&level="> ย้อนกลับ</a> ||	<a href="?type_doc=<?=$type_doc?>&typeproblem=<?=$typeproblem?>&schoolid=<?=$schoolid?>&problem_status_id=<?=$problem_status_id?>&xlv=<?=$_GET['xlv']?>&xsiteid=<?=$_GET['xsiteid']?>&profile_id=<?=$_GET['profile_id']?>&school_type=">แสดงทั้งหมด</a> |<a href="?type_doc=<?=$type_doc?>&typeproblem=<?=$typeproblem?>&schoolid=<?=$schoolid?>&problem_status_id=<?=$problem_status_id?>&xlv=<?=$_GET['xlv']?>&xsiteid=<?=$_GET['xsiteid']?>&profile_id=<?=$_GET['profile_id']?>&school_type=0&txt_title=(สังกัด สพป.)">สังกัด สพป.</a> |<a href="?type_doc=<?=$type_doc?>&typeproblem=<?=$typeproblem?>&schoolid=<?=$schoolid?>&problem_status_id=<?=$problem_status_id?>&xlv=<?=$_GET['xlv']?>&xsiteid=<?=$_GET['xsiteid']?>&profile_id=<?=$_GET['profile_id']?>&school_type=1&txt_title=(สังกัด สพม.)"> สังกัด สพม.</a></td></tr>
<tr>
