...
$arr_comment = array("1"=>"<font color=\"#FF9900\">ย้ายข้อมูลจากฐานกลางเข้าระบบ cmss เพื่อบันทึกข้อมูล</font>","2"=>"<font color=\"#009900\">เพิ่มข้อมูลในระบบ cmss เนื่องจากไม่มีทั้งในฐานกลางและ cmss</font>");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td colspan="6" align="left" bgcolor="#CCCCCC"><strong><a href="import_analysis_confirm.php?xsiteid=<?=$xsiteid?>&profile_id=<?=$profile_id?>">กลับหน้าหลัก</a> || <a href="report_datafalse.php?xsiteid=<?=$xsiteid?>&profile_id=<?=$profile_id?>" target="_blank">รายการที่ไม่สามารถประมวลผลได้ </a>|| สรุปผลการประมวลผลนำเข้าข้อมูลเพื่อบันทึกข้อมูลทะเบียนประวัติทั้งหมด</strong></td>
        </tr>
      <tr>
...
t1.status_keypass,
t1.flag_insert,t1.flag_process
FROM
...
where t1.siteid='$xsiteid' and t1.profile_id='$profile_id' and t1.flag_process IN('1','2')";
	...
	while($rs = mysql_fetch_assoc($result)){
      ...
      <tr bgcolor="<?=$bg?>">
        ...
        <td align="left"><? echo $arr_comment[$rs[flag_process]]?></td>
      </tr>
      <?
	}
	  ?>
