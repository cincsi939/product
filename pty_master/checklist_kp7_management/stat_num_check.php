     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
           ...
           <tr>
             <td width="17%" align="left" bgcolor="#FFFFFF"><strong>วันที่ตรวจสอบเอกสาร</strong></td>
            ...
            <INPUT name="button2" type="button"  onClick="popUpCalendar(this, form1.c_date2, 'dd/mm/yyyy')"value="วันเดือนปี">
            </label>
            <label> </label></td>
             </tr>
           <tr>
