...
ข้าราชการครูและบุคลากรทางการศึกษา (
    ...
    <? show_area($xsiteid) ?></strong></td>
           ...
           <tr>
             <td width="37%" align="left" bgcolor="#FFFFFF"><strong>จำนวนข้าราชการครูและบุคลากรทางการศึกษา (อัตราจริง)<SPAN lang="TH"></SPAN></strong></td>
...
<? } ######### END   }else{ if  ($lv == 1 ){   ?>    	 
 ...
 <tr>
  ...
  <tr>
	...
	<thead> 
      <tr>
        <th width="3%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong>ลำดับ</strong></th>
        <? if($lv == "1"){?>
        <th width="4%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong>รหัส<br>
          หน่วยงาน</strong></th>
        <? } //end ?>
        <th width="18%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong><?=$xtitle?></strong></th>
        ...
        <th width="6%" rowspan="2" align="center" bgcolor="#A8B9FF">
          <p>ได้รับ<br>
            เอกสาร<br>
            (คน)</p></th>
        <td colspan="2" align="center" bgcolor="#A8B9FF"><strong>ค้างรับ
          (คน)</strong></td>
        ...
        <th width="7%" rowspan="2" align="center" bgcolor="#A8B9FF">จำนวน<br>
          (แผ่น)</th>
        <th width="5%" rowspan="2" align="center" bgcolor="#A8B9FF"><strong><br>
          รูป</strong></th>
      </tr>
      <tr>
        <th width="6%" align="center" bgcolor="#A8B9FF">เลขบัตร<br>
          สมบูรณ์</th>
        <th width="7%" align="center" bgcolor="#A8B9FF">เลขบัตร<br>
          ไม่สมบูรณ์</th>
        <th width="9%" align="center" bgcolor="#A8B9FF"><strong>อยู่ระหว่าง<br>
          ตรวจสอบ</strong></th>
        <th width="7%" align="center" bgcolor="#A8B9FF"><strong>สมบูรณ์</strong></th>
        <th width="8%" align="center" bgcolor="#A8B9FF">เลขบัตร<br>
          ไม่สมบูรณ์</th>
...
";
		...
		$arrlog_site = CheckLockArea("",$profile_id);
...
$result = mysql_db_query($dbname_temp,$sql);
		...
		while($rs = mysql_fetch_assoc($result)){
			 if ($i++ %  2){ $bg = "#F0F0F0";}else{$bg = "#FFFFFF";}
			  ...
			  if($lv == ""){
				  ...
				  $count_norecive_idfalse = $arrN[$id_org]['numnorecive_idfalse'];// ค้างรับ (คน)
				 ...
				 // echo "<pre>";
				  ...
				  $count_norecive = $arrnum[$id_org]['numnorecive'];// ค้างรับ (คน)
				   $count_norecive_idfalse = $arrnum[$id_org]['numnorecive_idfalse'];// ค้างรับ (คน)
      ...
      <tr bgcolor="<?=$bg?>">
		...
		<? } //end ?>
        <td align="left"><?=$xalink?><? if($lv == "1"){ echo "<a href=\"main_report_detail_v1.php?action=&lv=2&xsiteid=$rs[siteid]&schoolid=$rs[id]&profile_id=$profile_id\" target=\"_blank\"> <img src=\"../validate_management/images/report.png\" width=\"16\" height=\"16\" title=\"คลิ๊กเพื่อแสดงรายงาน\" border=\"0\"></a>"; }?>
         </td>
		...
		<?
			...
			$sum_norecive_idfalse += $count_norecive_idfalse;
 ...
 <tfoot>
      <tr class="txthead">
        ...
        <td align="center" bgcolor="#CCCCCC"><strong>
         ...
         <td align="center" bgcolor="#CCCCCC"><strong><?=number_format($sum_norecive_idfalse)?></strong></td>
