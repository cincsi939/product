...
?>
&nbsp;<a href="../../report/report_keydata_main.php?profile_id=<?=$profile_id?>">กลับหน้าหลัก</a>
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
   <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td bgcolor="#E6E6E6"><table width="100%" border="0" cellspacing="1" cellpadding="3">
         <tr>
           <td colspan="7" align="center" bgcolor="#CCCCCC"><strong>รายงานผลการสแกนเอกสาร สำเนา กพ.7 ต้นฉบับ (
 ...
 <tr>
  ...
  ?>
  <tr>
    <td align="center" valign="middle" bgcolor="#E6E6E6"><table width="100%" border="0" cellspacing="1" cellpadding="3" id="my_table">
	<thead> 
      <tr>
        <th width="5%" rowspan="2" align="center" bgcolor="#CCCCCC"><strong>ลำดับ</strong></th>
        <th width="27%" rowspan="2" align="center" bgcolor="#CCCCCC"><strong><?=$xtitle?></strong></th>
        <th width="8%" rowspan="2" align="center" bgcolor="#CCCCCC"><strong>อัตราจริง<br>
รวม(คน)</strong></th>
        <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>ได้รับเอกสาร</strong></td>
        <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>เอกสารสมบูรณ์</strong></td>
        <td colspan="2" align="center" bgcolor="#CCCCCC"><strong>สแกนแล้ว </strong></td>
        <th width="8%" rowspan="2" align="center" bgcolor="#CCCCCC"><strong>ค้างสแกน (คน)</strong></th>
        </tr>
      <tr>
        <th width="10%" align="center" bgcolor="#CCCCCC">คน</th>
        <th width="8%" align="center" bgcolor="#CCCCCC">แผ่น</th>
        <th width="9%" align="center" bgcolor="#CCCCCC">คน</th>
        <th width="9%" align="center" bgcolor="#CCCCCC">แผ่น</th>
        <th width="8%" align="center" bgcolor="#CCCCCC">คน</th>
        <th width="8%" align="center" bgcolor="#CCCCCC">แผ่น</th>
        </tr> 
	</thead>    
	<tbody>   
