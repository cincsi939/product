  ...
  <tr>
    <td align="center" valign="middle" bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
		...
		echo $xsc['schoolname']   ;
		?> <a href="report_noproblem_comment.php?lv=<?=$lv?>&sentsecid=<?=$sentsecid?>&schoolid=<?=$schoolid?>&profile_id=<?=$profile_id?>&xsiteid=<?=$sentsecid?>" target="_blank">เอกสารสมบูรณ์แต่มี comment</a></td>
        </tr>
      <tr>
