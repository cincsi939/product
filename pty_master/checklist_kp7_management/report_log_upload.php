  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td bgcolor="#000000"><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr>
          <td colspan="11" align="left" bgcolor="#A5B2CE"><a href="script_manage_filepdf.php?action=&profile_id=<?=$profile_id?>">กลับหน้าโปรแกรม upload</a> || <strong>รายงาน log การ upload ไฟล์ 
            <?=GetEduArea($xsiteid);?>
          </strong></td>
        </tr>
        <tr>
        ...
        <?
        	...
        	$sql = "SELECT * FROM  log_upload_pdf WHERE siteid='$xsiteid' AND type_ref='N' ORDER BY date_upload DESC";
			$result = mysql_db_query($dbname_temp,$sql);
			$i=0;
			while($rs = mysql_fetch_assoc($result)){
...
WHERE
log_upload_pdf_detail.upload_id =  '$upload_id' $conv
