...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td align="left" valign="top"><table width="98%" border="0" align="center">
            <tr>
              <td width="13%"><a href="general.php?id=<?=$arr_general[id]?>&action=edit" class="pp" title="แก้ไขข้อมูลส่วนบุคคล"><img src="images/edit.png" width="16" height="16" align="absmiddle" border=""></a><a href="nosalary.php?id=<?=$id?>&action=edit" target="_self">แก้ไขข้อมูล</a> &nbsp; </td>
              <td width="87%"><a href="kp7_nosalary.php?id=<?=$id?>" title="ตรวจสอบข้อมูล กพ.7"><img src="../../../images_sys/pdf.gif" width="16" height="16" border="0" > ตรวจสอบเอกสารข้อมูล ก.พ.7 อิเล็กทรอนิกส์ </a></td>
            </tr>
          </table>
            <br>
            <form  method = POST  action = "?id=<?=$id?>" >
              ...
              <table width="98%" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="black">
                <tr bgcolor="#999999" align="center">
                  <td colspan="3" bgcolor="#2C2C9E"><span class="style1">วันที่ไม่ได้รับเงินเดือน หรือรับเงินเดือนไม่เต็มจำนวน</span> </td>
                </tr>
                <tr bgcolor="#999999" align="center"> 
                  <td bgcolor="#A3B2CC"><strong>ตั้งแต่วันที่</strong><strong>-ถึงวันที่</strong></td>
				  <td width="400" bgcolor="#A3B2CC"><strong>รายการ</strong></td>
				  <td width="250" bgcolor="#A3B2CC"><strong>เอกสารอ้างอิง</strong></td>
                </tr>
                <?
