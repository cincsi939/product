...
<tr>
    <td colspan="2" height="20">&nbsp;<b class="normal_blue">Insert Image</b></td>
</tr>
<tr>
	<td width="95" height="20" align="right">Image URL&nbsp;<b>:</b>&nbsp;</td>
    <td width="297">
	<input type="text" name="imageurl" id="imageurl" class="input" style="width:221px;" value="">&nbsp; 
	<button name="preview" onClick="return onPreview();" title="Preview the image in a new window" style="width:60px; height:18px">Preview</button>	
	</td>
</tr>	
<tr>
...
<tr>
	<td colspan="2" height="20">&nbsp;<img src="../admin/images/cam.gif" width="15" height="15" align="absmiddle">
