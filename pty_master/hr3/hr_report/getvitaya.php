...
// include ("../../../config/conndb_nonsession.inc.php")  ; 
    ...
    $result=mysql_db_query('edubkk_'.$xsiteid,$sql);
    $idmax=""; 
    $i=0;
...
where hr_addposition_now.`pid`= '$postname' and $con   order by vitaya.orderby";
$sql="SELECT DISTINCT
vitaya.vitayaname AS value,
vitaya.runid AS id,
hr_addradub.radub ,
...
radub_math_vitaya.level_id='$radub_id' and $con order by vitaya.orderby";
