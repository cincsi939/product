...
function _parsejpg($file){
	...
	//if(!$a)
		//$this->Error(' ! ระบบไม่สามารถพิมพ์เอกสารได้ เนื่องจากไฟล์รูปถ่ายของท่านไม่สมบูรณ์กรุณาตรวจสอบรูปภาพอีกครั้ง');
//	if($a[2]!=2)
	//	$this->Error(' ! ระบบไม่สามารถพิมพ์เอกสารได้ เนื่องจากประเภทไฟล์รูปถ่ายของท่านไม่ถูกต้องกรุณาอัพโหลดรูปถ่ายอีกครั้ง');
