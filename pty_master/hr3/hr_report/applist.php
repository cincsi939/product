...
<tr bgcolor="#ffffff">
	<td height="25">&nbsp;- <a href="../../../report/search/searcharea.php" target="_blank">ค้นหารายชื่อบุคลากรในสำนักงานเขตพื้นที่การศึกษา แบบละเอียด</a></td>
</tr>
	</table>
	  <p>
	    <? } elseif ($mode == "2") { ?>
     ...
     <div class="tabbertab">
      ...
      <table width="80%" cellspacing="1" cellpadding="2" align="center" bgcolor="#808080">
        ...
        <tr bgcolor="#ffffff">
		  ...
		  <a href="../../../report/percen_entry_v5area.php?xsiteid=<?=$_SESSION[siteid]?>" target="_blank">รายงานสถานะความครบถ้วน</a></td>
        </tr>
<?  
$xsiteid = $_SESSION[siteid] ; 
if (($xsiteid== 5001) or ($xsiteid== 5002) or ($xsiteid== 5003) or ($xsiteid== 5004) or ($xsiteid== 5005) ){ ?>		
        <tr bgcolor="#ffffff">
          <td height="25" bgcolor="#EFEFEF">- <a href="../../../report/percen_entry_v4area.php?xsiteid=<?=$_SESSION[siteid]?>">รายงานสถานะการรับรองข้อมูลเข้าสู่ระบบ</a></td>
        </tr>
<? } ####### END if (($xsiteid== 5001) or ($xsiteid== 5002) or ($xsiteid== 5003) or ($xsiteid== 5004) or ($xsiteid== 5005) ){ ?>		 		
         <!--
        <tr bgcolor="#ffffff">
