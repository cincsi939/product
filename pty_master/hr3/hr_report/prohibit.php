...
if(document.post.yy.value.length==0){
		...
		return false;
			...
			if(!confirm("วันเดือนปีไม่ตรงกับช่องแสดงผล กพ.7 ต้องการดำเนินการต่อหรือไม่")){
					...
					document.post.subject_error.value=document.post.subject_error.value+"::"+"วันเดือนปีไม่ตรงกับช่องแสดงผล กพ.7";
