...
$sql_view="SELECT * FROM general where id='$id' ";
...
$sql_sa1="select * from salary where id='$rsv[id]' ORDER BY  date DESC,salary DESC,dateorder DESC LIMIT 1";
      ...
      <tr>
        <td width="14%" height="515" valign="top"><?
          ...
          <? $j++; if($j>0){break;}
						 ...
						 ?></td>
        <td width="86%" valign="top" align="left"><table width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr>
            <td class="style1" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="376" rowspan="2"><font color="#000000">ข้อมูลสำคัญโดยย่อ รายงานจาก general </font></td>
                  <td width="425" align="right">รหัสประจำตัวประชาชน :
                    <?=$rsv[idcard];?></td>
                </tr>
                <tr>
          ...
          <tr>
            <td align="left"><table width="100%" border="0" align="left" cellpadding="3" cellspacing="1">
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" valign="top"><? echo " $rsv[prename_en] $rsv[name_en]   &nbsp;$rsv[surname_en]";?></td>
                </tr>
                <tr>
...
//					}	
                ...
                <tr>
                  ...
                  <td colspan="2" valign="top"><? 
								$sql_vitaya="select * from vitaya_stat where id='$rsv[id]' ORDER BY date_command DESC,updatetime ASC LIMIT 1";
...
//			echo $rs_royal[getroyal];
                ...
                <tr>
                  ...
                  <td colspan="2" valign="top"><? if($rssecname != ""){ echo "$rssecname<br>";}?>
                ...
                <tr>
                  ...
                  <td colspan="2" valign="top"><?
				  	//if($rsv[salary] > 0){
					//echo number_format($rsv[salary])." บาท"." ( ข้อมูล ณ วันที่ ".MakeDate($arr_salary[date])." ) ";
				//}else{
					echo number_format($arr_salary[salary])." บาท"." ( ข้อมูล ณ วันที่ ".MakeDate($arr_salary[date])." ) ";
				//}
				  ?></td>
                </tr>
                <tr>
...
?></td>
                ...
                <tr>
				 ...
				 if($rsv[contract_add]!=""){
					...
					$sql_address = "SELECT * FROM hr_addhistoryaddress WHERE gen_id='$rsv[id]' and kp7_active='1' ORDER BY daterec DESC , updatetime DESC LIMIT 1";
					//echo $sql_address;
