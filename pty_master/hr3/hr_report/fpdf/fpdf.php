...
function Header()
	...
	global $word_wk;
		//Put watermark
		if($word_wk == 'ESV'){
			// $this->SetFont($this->font_format, '', 90);
			// $this->SetTextColor(255, 192, 203);
			// $this->RotatedText(80, 150, $word_wk, 0);
			$this->Image('images/c51ce410c124a10L_2.jpg', 55, 75, 100, 150, 'JPG');
		}
		else{
			if($word_wk=="สำเนา" OR $word_wk=="ตัวอย่าง" OR $word_wk=="Preview"){$setx1=80;}else{$setx1=30;}
			$this->SetFont($this->font_format,'',90);
			$this->SetTextColor(255, 192, 203);
			$this->RotatedText($setx1, 150, $word_wk, 0);
		}
	}
...
function _parsejpg($file)
{
	...
	$a=@GetImageSize($file);
	if(!$a)
		$this->Error(" ! ระบบไม่สามารถพิมพ์เอกสารได้ เนื่องจากไฟล์รูปถ่ายของท่านไม่สมบูรณ์กรุณาวจสอบรูปภาพอีกครั้ง : $file ");
	if($a[2]!=2)
		$this->Error(" ! ระบบไม่สามารถพิมพ์เอกสารได้ เนื่องจากประเภทไฟล์รูปถ่ายของท่านไม่ถูกต้องกรุณาอัพโหลดรูปถ่ายอีกครั้ง  : $file ");
...
function AddThaiFonts()
{
	...
	//font : Th Sarabun
	$this->AddFont('Th Sarabun'	,''		,'thsarabun.php');
	$this->AddFont('Th Sarabun'	,'B'	,'thsarabunb.php'); //Bold
	$this->AddFont('Th Sarabun'	,'I'	,'thsarabuni.php'); //Italic	
	$this->AddFont('Th Sarabun'	,'Z'	,'thsarabunbi.php'); //Bold and Italic
