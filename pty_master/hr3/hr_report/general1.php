...
//unit='$unit',
				$sql = "update general set prename_th=trim('$prename_th'),name_th=trim('$name_th'),surname_th=trim('$surname_th'),prename_en=trim('$prename_en'),name_en=trim('$name_en'),surname_en=trim('$surname_en'),who='$who',whom='$whom',persontype='$persontype',royalid='$royalid',taxid='$taxid',radub_past='$radub_past',sex='$sex',position='$position',blood='$blood',marry='$marry',region='$region',home='$home',begindate='$begindate',startposition='$startposition',birthday='$birthday',contact_add='$contact_add',father=trim('$father'),mother=trim('$mother'),marryname=trim('$marryname'),subminis='$subminis',minis='$minis',persontype2_now='$persontype2_now',subminis_now='$subminis_now',minis_now='$minis_now',endday='$enddate',father_occ='$father_occ',mother_occ='$mother_occ',marry_occ='$marry_occ', contact_tel='$contact_tel' ,positiongroup ='$positiongroup' , work='$work',noteref='$noteref',secondname_th=trim('$secondname_th') ,secondname_en =trim('$secondname_en') , idcard='$idcard', marry_prename=trim('$marry_prename'), marry_name=trim('$marry_name'), marry_surname=trim('$marry_surname'), father_prename=trim('$father_prename'), father_name=trim('$father_name'), father_surname=trim('$father_surname'), mother_prename=trim('$mother_prename'), mother_name=trim('$mother_name'), mother_surname=trim('$mother_surname'),marry_kp7='$marry_kp7',label_persontype2now='$label_persontype2now' $up_startdate $start_date_manual $up_school $up_birthday_label $up_retire_label $up_startdate_label  where id ='$id' ;";
			//echo $sql."<hr>";
	...
	//   ตรวจสอบ การกรอก label วันเดือนปีเกิด
		...
		// ตรวจสอบ การกรอกวันเกษียณอายุราชการ
			if(f1.retire_label.value != ""){
					if((f1.retire_label.value.length <= 7)){
...
?>
                                  ...
                                  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="textp">
                                    <tr>
                                      ...
                                      <td width="43%" height="25"><input name="who" type="text"   value="<? if($rs[who]==""){ echo "ไทย"; }else{ echo $rs[who]; } ?>" size="20" ></td>
                                      <td width="11%" height="25">เชื้อชาติ</td>
                                      <td width="28%" height="25"><input name="whom" type="text"   value="<? if($rs[whom]==""){ echo " ไทย"; }else{ echo $rs[whom]; } ?>" size="20"></td>
                                    </tr>
                                    <tr>
...
?>
           ...
           <input type="button" name="typedate2" value=" + " title="วัน เดือน ปี เกิดตาม ข้อ 2(ส่วนหลัง)" onClick="MM_openBrWindow('type_showdate2.php','<?=$idcard;?>','scrollbars=yes,width=1000,height=600')"></td>
                                    ...
                                    <tr>
                                      <td height="25">&nbsp;</td>
                                      <td height="25"><label>
                                        <input type="text" name="birthday_label" id="birthday_label" value="<?=$rs[birthday_label]?>" size="25">
                                        <br>
                                        ส่วนแสดงผลวันเดือนปีเกิดใน ก.พ.7
                                      </label></td>
...
?>
                                    ...
                                    <tr>
                                      <td height="25">&nbsp;</td>
                                      <td height="25"><label>
                                        <input name="startdate_label" type="text" size="25" value="<?=$rs[startdate_label]?>">
                                      ส่วนแสดงผลวันสั่งบรรจุใน ก.พ.7
                                      </label></td>
                                      <td height="25">&nbsp;</td>
                                      <td height="25">&nbsp;</td>
                                    </tr>
...
<tr>
  ...
  <td height="25">&nbsp;</td>
							...
							<? 	$select1  = mysql_query("select *  from $dbnamemaster.hr_positiongroup ;");?>
                                   ...
                                   <option value="0"<? if($rs[positiongroup]=="0"){echo "selected";}?>>ไม่ระบุ</option>
                                        <?
...
?>									  
                                        ...
                                        <select name="schoolid" style="width:300;" <?=$dis_lock?>>       
					...
					?>
					 ...
					 ?>
                                    ...
                                    echo $rs[minis_now]."<br>".$rs[subminis_now];
									  ?>
                                      <select name="minis_now"  style="width:300;"  onChange="getorg(this.value)">
                                        <? 
									   $id_org="";
