...
#########################################################
$ApplicationName	= "competency_percen_entry";
$module_code 		= "percen_entry"; 
$process_id			= "percen_entry";
$VERSION 				= "9.91";
$BypassAPP 			= true;
#########################################################
#Developer 	:: Rungsit
...
<tr bgcolor="#A3B2CC"  style="font-weight:bold;"     align="center"            >
  <td width="15%" height="51" class="boder_rb">ทั้งหมด (คน) </td>
  <td width="15%" class="boder_rb">อยู่ระหว่าง บันทึกข้อมูล (คน) </td>
...
<tr bgcolor="#A3B2CC" align="right" style="font-weight:bold;">
  <td colspan="6" align="left" class="boder_rb">&nbsp;</td>
  </tr>
</table>
