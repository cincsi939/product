...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td align="left" valign="top">&nbsp;<a href="kp7_nosalary.php?id=<?=$id?>" title="ตรวจสอบข้อมูล กพ.7"> <img src="../../../images_sys/pdf.gif" width="16" height="16" border="0" > ตรวจสอบเอกสารข้อมูล ก.พ.7 อิเล็กทรอนิกส์ </a> <br>
...
<table width="98%" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="black">
                <tr bgcolor="#999999" align="center">
                  <td colspan="6" bgcolor="#2C2C9E"><span class="style1">วันที่ไม่ได้รับเงินเดือน หรือรับเงินเดือนไม่เต็มจำนวน</span> </td>
                </tr>
                <tr bgcolor="#999999" align="center"> 
                  <td width="97" bgcolor="#A3B2CC"><strong>ตั้งแต่วันที่</strong></td>
				  <td width="96" bgcolor="#A3B2CC"><strong>ถึงวันที่</strong></td>
                  <td width="380" bgcolor="#A3B2CC"><strong>รายการ</strong></td>
				  <td width="199" bgcolor="#A3B2CC"><strong>เอกสารอ้างอิง</strong></td>
                  <td width="95" bgcolor="#A3B2CC">แสดงผลใน ก.พ. 7</td>
...
?>
              ...
              <table width="90%" border="0" cellspacing="2" cellpadding="0" align="center">
                <tr> 
                  <td align="right" valign="top" width="258"><font color="red">*</font> <B>ตั้งแต่ วันที่</B></td>
                  <td align="left" valign="top" width="616"> 
                    <?dateInput($rs[fromdate],"from");?>                  </td>
                </tr>
				<tr> 
                  <td align="right" valign="top" width="258"><font color="red">*</font> <B>ถึง วันที่</B></td>
                  <td align="left" valign="top" width="616"> 
                    <?dateInput($rs[todate],"to");?>                  </td>
                </tr>
                <tr> 
                  <td align="right" valign="top" width="258"><B>รายการ</B></td>
                  <td align="left" valign="top" width="616"> <TEXTAREA NAME="comment" ROWS="7" COLS="60"><?=$rs[comment]?></TEXTAREA>				  </td>
                </tr>
				<tr> 
                  <td align="right" valign="top" width="258"><B>เอกสารอ้างอิง</B></td>
                  <td align="left" valign="top" width="616"> 
              ...
              <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#333333">
                <tr valign="middle"> 
                  <td align="center" colspan=2> &nbsp;&nbsp; 
                    ...
                    <input type="reset" value="  ยกเลิก  " ONCLICK="location.href='?id=<?=$id?>';">
