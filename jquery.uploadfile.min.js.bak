...
(function(b) {
    ...
    b.fn.uploadFile = function(f) {
        ...
        function j(y, x) {
            ...
            this.statusbar = b("<div class='ajax-file-upload-statusbar'><div style='text-align:top;'>คำอธิบาย : <input type='text' style='width:300px;' class='caption_input' id='in1' onKeyup=\"$('#form_" + x.req_id + "_" + x.doc_id + "_" + n.fileCounter + "').attr('action',$('#form_" + x.req_id + "_" + x.doc_id + "_" + n.fileCounter + "').attr('action')+'&caption='+$(this).val()); \" value='+datavar1[0];+'></div></div>").width(400);
