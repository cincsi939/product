...
(function(b) {
    ...
    b.fn.uploadFile = function(f) {
        ...
        function j(y, x) {
			var datavar1 =["แบบลงทะเบียนเพื่อขอรับสิทธิฯ (ดร.01)",
							"แบบรับรองสถานะของครัวเรือน (ดร.02)",
							"สำเนาบัตรประชาชนของหญิงตั้งครรภ์/มารดา 1 ฉบับ",
							"เอกสารการฝากครรภ์หรือสมุดบันทึกสุขภาพแม่และเด็กมาแสดง(เจ้าหน้าที่บันทึกสถานที่ฝากครรภ์และกำหนดคลอด)",
							"สำเนาสูติบัตรเด็ก 1 ฉบับ (ยื่นหลังจากคลอดบุตรแล้ว)",
							"หนังสือมอบอำนาจ (ดร.05)"];
            this.statusbar = b("<div class='ajax-file-upload-statusbar'><div style='text-align:top;'>คำอธิบาย : <input type='text' style='width:300px;' class='caption_input' onKeyup=\"$('#form_" + x.req_id + "_" + x.doc_id + "_" + n.fileCounter + "').attr('action',$('#form_" + x.req_id + "_" + x.doc_id + "_" + n.fileCounter + "').attr('action')+'&caption='+$(this).val()); \" value='"+datavar1[(parseInt(x.doc_id)-1)]+"'></div></div>").width(400);
