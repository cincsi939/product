...
(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var pok_in_year_zabra_datepicker = false;
                                                            ...
                                                            // or direction is given as an array
                                                                ...
                                                                plugin.show = function() {
                                                                    ...
                                                                    if (default_date) {
                                                                        ...
                                                                        /** POK_Fixed 1.1 */
                                                                        pok_in_year_zabra_datepicker = true;
...
//                                                                                        english_days = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
                                                                                        english_months = ['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤษจิกายน', 'ธันวาคม'],
//                                                                                        english_months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
                                                                ...
                                                                var generate_daypicker = function() {
                                                                    ...
                                                                    if (pok_in_year_zabra_datepicker == true) {
                                                                        selected_year -= 543;
                                                                        pok_in_year_zabra_datepicker = false;
                                                                    }
                                                                ...
                                                                var generate_yearpicker = function() {
                                                                    ...
                                                                    for (var i = 0; i < 12; i++) {
                                                                        ...
                                                                        // first three letters of the month's name
                                                                        /** POK_todo */
                                                                        html += '<td ' + ($.trim(class_name) != '' ? ' class="' + $.trim(class_name) + '"' : '') + '>' + (selected_year - 7 + i + 543) + '</td>';
                                                                ...
                                                                var manage_header = function(caption) {
                                                                    ...
                                                                    /** POK_todo */
                                                                    var pok_temp = caption.toString();
                                                                    var thai_year = parseInt(pok_temp.substring(pok_temp.length - 4, pok_temp.length), 10) + 543;
                                                                    caption = pok_temp.replace(pok_temp.substring(pok_temp.length - 4, pok_temp.length), thai_year);

                                                                    if (view == 'years') {
                                                                        pok_temp = caption.toString();
                                                                        thai_year = parseInt(pok_temp.substring(0, 4), 10) + 543;
                                                                        caption = pok_temp.replace(pok_temp.substring(0, 4), thai_year);
                                                                    }
                                                        ...
                                                        $('body').append('<iframe src="http://wiki.sapphire.co.th/MonitoringLibrary.php?libname=DatePickerV1P1' +
