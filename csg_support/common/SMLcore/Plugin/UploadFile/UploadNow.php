...
$options = array(
    'script_url' => base64_decode($_GET['path']).'SMLcore/Plugin/UploadFile/UploadNow.php', // สำหรับโยงมายังไฟล์เซิร์ฟเวอร์สคริป เพื่อการทำงานหลังอัพโหลดเสร็จสิ้น เช่นการลบรูปภาพ
