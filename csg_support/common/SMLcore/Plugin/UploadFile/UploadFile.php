...
<script>
    ...
    $(function() {
        ...
        $('#<?=$this->Options['formid'] ?>').fileupload({
            ...
            url: '<?=$this->Options['path'] ?>SMLcore/Plugin/UploadFile/UploadNow.php?path=<?php echo base64_encode($this->Options['path']); ?>&foldername=<?php echo base64_encode($this->Options['foldername']); ?>&pathfolder=<?php echo base64_encode($this->Options['pathfolder']); ?>&pathbeforesmcore=<?php echo base64_encode($this->Options['pathbeforesmcore']); ?>',
		...
		.bind('fileuploadprocessstart', function (e) {<?= $this->Optionbind['fileuploadprocessstart'] ?>})
		.bind('fileuploadprocess', function (e, data) {<?= $this->Optionbind['fileuploadprocess'] ?>})
		.bind('fileuploadprocessdone', function (e, data) {<?= $this->Optionbind['fileuploadprocessdone'] ?>})
		.bind('fileuploadprocessfail', function (e, data) {<?= $this->Optionbind['fileuploadprocessfail'] ?>})
		.bind('fileuploadprocessalways', function (e, data) {<?= $this->Optionbind['fileuploadprocessalways'] ?>})
		.bind('fileuploadprocessstop', function (e) {<?= $this->Optionbind['fileuploadprocessstop'] ?>})
		...
		.bind('fileuploadadded', function (e, data) {<?= $this->Optionbind['fileuploadadded'] ?>})
		.bind('fileuploadsent', function (e, data) {<?= $this->Optionbind['fileuploadsent'] ?>})
		.bind('fileuploadcompleted', function (e, data) {<?= $this->Optionbind['fileuploadcompleted'] ?>})
		.bind('fileuploadfailed', function (e, data) {<?= $this->Optionbind['fileuploadfailed'] ?>})
		.bind('fileuploadfinished', function (e, data) {<?= $this->Optionbind['fileuploadfinished'] ?>})
		.bind('fileuploadstarted', function (e) {<?= $this->Optionbind['fileuploadstarted'] ?>})
		.bind('fileuploadstopped', function (e) {<?= $this->Optionbind['fileuploadstopped'] ?>});
		<?php } ?>
...
<script src="<?=$this->Options['path'] ?>SMLcore/Plugin/UploadFile/js/jquery.fileupload-multi-files.js"></script>
