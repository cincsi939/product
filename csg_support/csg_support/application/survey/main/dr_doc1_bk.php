...
if($_GET['eq_id'] != ""){ # กรณีเป็นการแก้ไขข้อมูล
	$msg_title = "แก้ไขข้อมูลแบบลงทะเบียนขอรับสิทธ์เงินอุดหนุนเพื่อการเลี้ยงดูเด็กแรกเกิด<br>".$rs_org['groupname'];
}else{
	$msg_title = "เพิ่มข้อมูลแบบลงทะเบียนขอรับสิทธ์เงินอุดหนุนเพื่อการเลี้ยงดูเด็กแรกเกิด<br>".$rs_org['groupname'];
}
?>
...
<tbody>
	<tr>
   	  <td align="left" colspan="3"><b><u>ส่วนที่ 1</u></b> <b>ข้อมูลหญิงตั้งครรภ์/มารดา (ผู้ลงทะเบียน)</b></td>
    </tr>
    <tr>
	 <td height="25" width="5%" align="right"></td>
   	  <td align="left" width="70%">ลงทะเบียน ณ วันที่ <?php
    ...
    <tr>
      ...
      <td height="25" valign="middle">
        ...
        <span  id="idClassCheck" class="bIdCard">ตรวจสอบ</span>   <span  id="random2" class="bIdCard">สุ่มเลขบัตร</span><br><span class="style1"> * กรณีไม่มีข้อมูลเลขประจำตัวประชาชนท่านสามารถสุ่มเลข เพื่อบันทึกข้อมูลขอรับสิทธ์เงินอุดหนุนฯ</span></td>
      </tr>
	  <tr>
    	<td height="25" align="right"></td>
    ...
    <tr>
      ...
      <td height="25">
        คำนำหน้าชื่อ&nbsp;<span class="style1">*</span>
          ...
          ชื่อ <input name="v1" type="text" value="<?php echo $value[1]; ?>" id="v1" size="20"/>
          นามสกุล
    ...
    <tr>
		...
		?>
        <td align="left" width="20"><input type="hidden" name="v907" id="v907" value="1" <?php //echo $check1;?>/></td>
        <td align="left">ลงทะเบียนระหว่างตั้งครรภ์</td>
    </tr>
     <tr>
	...
	<td height="25" ></td>
   	  <td align="left"><b>ข้อมูลบิดาของเด็ก</b> (กรณีมารดาเด็กเป็นบุคคลต่างด้าว หรือเป็นบุคคลไร้สถานะทางทะเบียนราษฎร์ หรือเสียชีวิต อนุโลมให้บิดาของเด็กตามสูติบัตรผู้มีคุณสมบัติซึ่งมีสัญชาติไทย ลงทะเบียนแทน)</td>
   	  
    </tr>
	<tr class="father_data">
    	<td height="25" ></td>
        <td align="left">ชื่อ(นาย) <input type="text" name="v412" id="v412" value="<?php echo $value[412];?>"> นามสกุล <input type="text" name="v413" id="v413" value="<?php echo $value[413];?>"></td>
    </tr>
	<tr class="father_data">
    	<td height="25" ></td>
        <td align="left">เลขประจำตัวประชาชน <input type="text" name="v414" id="v414" value="<?php echo $value[414];?>" onKeyPress="CheckNum()"> <span  id="idClassCheck2" class="bIdCard">ตรวจสอบ</span> <span  id="random3" class="bIdCard">สุ่มเลขบัตร</span></td>
		
    </tr>
	<tr class="father_data">
	<td height="25" ></td>
		<td align="left">หมายเลขโทรศัพท์ที่สามารถติดต่อได้ <input type="text" value="<?php echo $value[418]; ?>"  name="v418" id="v418"/></td>
     ...
     <?php
		...
		?>
    <tr height="50px;">
      <td align="right" colspan="3" valign="middle"><input type="submit" style="cursor:pointer; width:100px; height:30px;" value="บันทึก">
