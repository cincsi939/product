...
<table width="90%" align="center">
	<tr>
    	<td align="left"><b><u>ส่วนที่ 2</u> สำหรับเจ้าหน้าที่เป็นผู้บันทึก</b></td>
    </tr>
    <tr>
    	<td align="left"><b><u>ข้อมูลการเกิดของเด็ก</u></b>(บันทึกภายหลังเมื่อเด็กเกิดแล้ว)</td>
    </tr>
    <tr>
    	<td align="left">เลขประจำตัวประชาชน&nbsp;<INPUT name="idcard" type="text" id="idcard" value="<?php echo $row['eq_idcard'];?>" size="30" class="numberonly"/>        
     ...
     <tr>
    	<td align="left">
            ...
            &nbsp;ชื่อ&nbsp;<input type="text" id="firstname" name="firstname" value="<?php echo $row['eq_firstname'];?>" style="width:200px;">
        	&nbsp;นามสกุล&nbsp;<input type="text" id="surname" name="surname" value="<?php echo $row['eq_lastname'];?>" style="width:300px;">
        </td>
    </tr>
    <?php
    ...
    <tr>
    	<td align="left">
        	วันเดือนปีเกิด&nbsp;<input 	type="text" 
											class="datepick" 
											name="birthDate" 
                                            id = "birthDate" 
    ...
    <tr>
    	<td align="left">
        	ตามใบสูติบัตรเลขที่&nbsp;<input type="text" id="bdoc_no" name="bdoc_no" value="<?php echo $row['eq_bdoc_no'];?>" style="width:80px;">&nbsp;
            ออกให้โดย&nbsp;<input type="text" id="bdoc_staff" name="bdoc_staff" value="<?php echo $row['eq_bdoc_staff'];?>" style="width:200px;">&nbsp;
            เมื่อวันที่&nbsp;<input 	type="text" 
											class="datepick" 
											name="docDate" 
                                            id = "docDate" 
    ...
    <tr>
    	<td align="left">
        	คลอด ณ&nbsp;<input type="text" id="birthPlace" name="birthPlace" value="<?php echo $row['eq_birthPlace'];?>" style="width:600px;"/>
        </td>
    </tr>
     <tr>
    	<td align="left">
     ...
     <tr>
    	<td align="left">
			...
			?>
            <input type="radio" name="presStatus" value="1" <?php echo $check1;?>>&nbsp;มารดาเลี้ยงดูเด็กเอง<br>
            <input type="radio" name="presStatus" value="2" <?php echo $check2;?>>&nbsp;ให้ผู้อื่นเลี้ยงดู (ระบุ)&nbsp;<input type="text" id="comment" name="comment" value="<?php echo $row['eq_comment'];?>" style="width:300px;">
        </td>
    </tr>
     <tr>
    	<td align="left">
    ...
    <tr>
    	<td align="left">
			...
			?>
        	<input type="radio" name="stayPlace" value="1" <?php echo $check1;?>>&nbsp;อยู่ที่เดียวกับมารดา<br>
            <input type="radio" name="stayPlace" value="2" <?php echo $check2;?>>&nbsp;ไม่ได้อยู่กับมารดา (ระบุที่อยู่)
        </td>
    </tr>
    <tr>
        ...
        <tr>
          <td align="left">บ้านเลขที่ <INPUT type="text" value="<?php echo $row['eq_address'];?>" name="address1" style="width:50px;" id="address1" /> หมู่ที่ <input type="text" value="<?php echo $row['eq_village'];?>"  name="address2" style="width:50px" id="address2" /> หมู่บ้าน <input type="text" value="<?php echo $row['eq_subvillage'];?>"  name="address8" style="width:100px" id="address8" /> ตรอก/ซอย <input type="text" value="<?php echo $row['eq_alley'];?>"  name="address9" style="width:80px" id="address9" /> ถนน <input type="text" value="<?php echo $row['eq_street'];?>" name="address3" style="width:100px;" id="address3" /> จังหวัด <select id="address4" name="address4" onChange = "chgAmphur(this.value);"  style="width:100px;" ><option value="">โปรดระบุ</option>
            <?php
        ...
        อำเภอ <LABEL id="lblAmphur">
		  ...
		  รหัสไปรษณีย์ <input type="text" value="<?php echo $row['eq_postcode'];?>"  name="eq_postcode" style="width:150px;" id="eq_postcode"/>
