...
<div>
<iframe id="ifram" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/csg_support/application/reportbuilder_opp/report_preview.php?id=440&yy=<?=$yy?>" width="100%"  frameborder="0" onload="resizeIframe(this)"></iframe>
</div>
<p>
<table width="100%">
	<tr>
