 ...
 //print_r($_POST);
	...
	&& in_array($extension, $allowedExts)) {
	  if ($_FILES["v378"]["error"] > 0) {
		...
		if (file_exists("../../../../repo_opp/profile/" . $_FILES["file"]["name"])) { //ตั้งค่าที่อยู่ไฟล์เก็บรูปภาพ
		   $_FILES["v378"]["name"] . " already exists. ";
		}  {
		  move_uploaded_file($_FILES["v378"]["tmp_name"],
		  "../../../../repo_opp/profile/" . $_FILES["v378"]["name"]);
		   "Stored in: " . "../../../../repo_opp/profile/" . $_FILES["v378"]["name"];
		}
