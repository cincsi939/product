 ...
 */
 ...
 <?php
	...
	$con->delete('eq_var_data','pin = '.$PIN.' AND form_id=1');
	...
	$con->delete('eq_person',"eq_idcard = ".$PIN." AND eq_year='".(date('Y')+543)."' AND eq_round = 1");
	...
	/*$sql = "
		update eq_person set 
			eq_code_prename = '".$_POST['v3']."',
			eq_prename = getDetail(4,".$_POST['v376']."),
			eq_firstname = '".$_POST['v3']."',
			eq_lastname = '".$_POST['v3']."',
			eq_address = '".$_POST['v3']."',
			eq_village = '".$_POST['v3']."',
			eq_street = '".$_POST['v3']."',
			eq_code_parish = '".$_POST['v3']."',
			eq_parish = '".$_POST['v3']."',
			eq_code_district = '".$_POST['v3']."',
			eq_district = '".$_POST['v3']."',
			eq_code_province = '".$_POST['v3']."',
			eq_province = '".$_POST['v3']."',
			eq_code_gender = '".$_POST['v3']."',
			eq_gender = '".$_POST['v3']."',
			eq_birthday = '".$_POST['v3']."',
			eq_age = '".$_POST['v3']."',
			eq_code_education = '".$_POST['v3']."',
			eq_education = '".$_POST['v3']."',
			eq_code_relation = '".$_POST['v3']."',
			eq_relation = '".$_POST['v3']."',
			eq_code_career = '".$_POST['v3']."',
			eq_career = '".$_POST['v3']."',
