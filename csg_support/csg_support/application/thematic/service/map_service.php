...
$type_page = ($_GET['type_page'] != '')?$_GET['type_page']:'';
...
$hrefurl = base64_decode($_GET['hrefurl']);
//echo $type_page.'<br/>';
//echo $hrefurl = $hrefurl;
			...
			downloadUrl(url, function(data) {
				...
				all_polygonMap[url] = Array();
			 	...
			 	for (var i = 0; i < markers.length; i++) {
					...
					all_markers[url][i] = createMarkerUrl(markers[i].getAttribute("name"), markers[i].getAttribute("identify"), markers[i].getAttribute("icon"), latlng, hrefurl, markers[i].getAttribute("mapid"),type_page);
...
<tr>
    <td>
<input type="checkbox" id="xml<?php echo $cate;?>" name="xml<?php echo $cate;?>" value="xml.map_service.php?ac=<?php echo $cate;?>&datatarget=<?php echo $arrDataDatatarget[$k];?>&data=<?php echo $arrDataDataset[$k];?>&max_data=<?php echo $maxData;?>&type_page=<?php echo $type_page;?>"  checked="checked"  onClick="addlayerXML(this);" />
</td>
  </tr>
<?php
}
