...
function show_modify(modify_date){
	...
	/*New Windows Popup By Aussy; 2009-08-21 21:33pm*/
	var win = null;
	...
	// ตรวจสอบนามสกุลไฟล์ประเภทรูปภาพ
	function imgValidate( e ){
		var extensions = new Array("jpg","jpeg","gif","png","bmp","tif");
		var image_file = document.getElementById(e).value;
		var image_length = document.getElementById(e).value.length;
		...
		alert("สามารถอัพโหลดไฟล์รูปภาพประเภท : "+ extensions.join(', '));
