...
<?php
	...
	if(isset($_GET['id']))
	{
		$sql = "select siteid,form_id,number_action,pin,child_userid,vid,yy,mm,value from eq_var_data where siteid=1 AND form_id=1 AND pin='".$_GET['id']."'";
		$results = $con->select($sql);
		foreach($results as $row)
		{
			$value[$row['vid']] = $row['value'];
		}
		$action = 'form1_edit_exc.php';
		
		/*--------------------------------------------------------------------------------------- set Database*/
	}
	else
	{
		$action = 'form1_exc.php';
	}
?>
...
<tbody>
	<tr>    
       ...
       <?php /*?> <INPUT name="round" type="hidden" id="round" value="<?php if($_GET['rond']){echo $_GET['rond'];}else{echo 1;} ?>" size="1"  /><?php */?>
    ...
    <tr>
      ...
      <?php
		...
		{
			$valueImg = '<img src="../img/profile/'.$value['378'].'" width="150" height="180" id="imgprvw" alt="uploaded image preview" name="pPicture">';
		}
	  ?>
      <?php echo $valueImg; ?>
        <input type="File" name="v378" id="v378" onChange="showimagepreview(this)" ></td>
    </tr>
    <tr>
      <td height="25" align="right">1.</td>
      <td height="25" colspan="2" valign="middle">
        เลขบัตรประจำตัวประชาชน<span class="style1"> *</span>
        <INPUT name="v3" type="text" id="v3" value="<?php echo $value[3]; ?>" size="30" <?php if($value[3]==''){}else{echo 'readonly';} ?>  />        
    ...
    <tr>
      ...
      <td height="25" colspan="2"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td width="21%"><input name="v1" type="text" value="<?php echo $value[1]; ?>" id="v1" size="20"  /></td>
          <td width="10%" align="center">นามสกุล</td>
          <td width="21%"><input type="text" value="<?php echo $value[2]; ?>"  name="v2" id="v2" size="20"/></td>
        </tr>
      </table></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="25" colspan="2" valign="middle"><table width="471" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
          ...
          <td><input type="text" value="<?php echo $value[6]; ?>"  name="v6" style="width:90%" id="v6" /></td>
    ...
    <tr>
      ...
      <LABEL id="lblPreName">
      	<input name="v12" type="radio"  class="v12" id="female"  value="1" <?php if($value[12]==1){echo 'checked';} ?>  />1. หญิง&nbsp;
      	<input type="radio"  value="2" class="v12" name="v12"  id="male" <?php if($value[12]==2){echo 'checked';} ?> />2. ชาย
...
ปี</td>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td height="25"><input name="v15" type="radio"  id="rTypeHome_1"  value="1" <?php if($value[15]==1){echo 'checked';} ?> />1. บ้านตัวเอง</td>
      <td height="25" colspan="2">	<input name="v15" type="radio"  value="2" id="rTypeHome_2" class="Typehome"   <?php if($value[15]==2){echo 'checked';} ?>/>
        2. บ้านเช่า จ่ายค่าเช่า
<INPUT name="v16" type="text" id="v16" value="<?php echo $value[16];  ?>" size="10" class="numberOnly" />
        บาท/เดือน/ปี</td>
      </tr>
     <tr>
      <td height="25" align="right">&nbsp;</td>
      <td height="25"><input name="v15" type="radio"  value="3" id="rTypeHome_3"  <?php if($value[15]==3){echo 'checked';} ?>  />
3. บ้านญาติ </td>
      <td height="25" colspan="2"><input name="v15" type="radio"  value="4" id="rTypeHome_4" class="Typehome"  <?php if($value[15]==4){echo 'checked';} ?>/>
        4. อื่น ๆ ระบุ        
        <INPUT name="v17" type="text" id="v17" value="<?php echo $value[17];  ?>" style="width:80%" /></td>
      </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3" align="right"><textarea name="v18" id="v18" style="width:100%" rows="8"><?php echo $value[18];  ?></textarea></td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><textarea name="v19" id="v19" style="width:100%" rows="8"><?php echo $value[19];  ?></textarea></td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><textarea name="v20" id="v20" style="width:100%" rows="8"><?php echo $value[20];  ?></textarea></td>
      </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><textarea name="v21" id="v21" style="width:100%" rows="8"><?php echo $value[21];  ?></textarea></td>
      </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input    name="v22" type="radio"  id="v22_1"  value="1" <?php if($value[22]==1){echo 'checked';}elseif($value[22]==''){echo 'checked';} ?> />
        ไม่ได้ศึกษา</td>
      <td width="282" ><input type="radio"  value="2"  id="v22_2"  name="v22" <?php if($value[22]==2){echo 'checked';} ?> />
        ต่ำกว่าประถมศึกษา</td>
      <td ><input type="radio"  value="3"  id="v22"    name="v22" <?php if($value[22]==3){echo 'checked';} ?> />
        ประถมศึกษา</td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="4"  id=""    name="v22" <?php if($value[22]==4){echo 'checked';} ?> />
      มัธยมศึกษาตอนต้น</td>
      <td ><input type="radio"  value="5"  id=""    name="v22" <?php if($value[22]==5){echo 'checked';} ?> />
        มัธยมศึกษาตอนปลาย</td>
      <td ><input type="radio"  value="6"  id="v22"    name="v22" <?php if($value[22]==6){echo 'checked';} ?> />
        มัธยมศึกษาตอนปลาย/ปวช</td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="7"  id=""    name="v22" <?php if($value[22]==7){echo 'checked';} ?> />
      อนุปริญญา/ปวส</td>
      <td ><input type="radio"  value="8"  id=""    name="v22" <?php if($value[22]==8){echo 'checked';} ?> />
        ปริญญาตรี</td>
      <td ><input type="radio"  value="9"  id="v22"    name="v22" <?php if($value[22]==9){echo 'checked';} ?> />
        สูงกว่าปริญญาตรี</td>
      </tr>
    <tr>
    ...
    <tr class="careertable">
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="checkbox"  value="1"  id="cCareer1"    name="v23" class="cCareer" <?php if($value[23]!=''){echo 'checked';} ?> />
        1. รับจ้างทั่วไป</td>
      <td >        <input type="checkbox"  value="2"  id="cCareer2"    name="v24" class="cCareer" <?php if($value[24]!=''){echo 'checked';} ?> />
      2. เกษตรกร </td>
      <td >&nbsp;</td>
    </tr>
    <tr class="careertable">
      <td height="25" align="right">&nbsp;</td>
      <td >        <input type="checkbox"  value="3"  id="cCareer3"    name="v25" class="cCareer" <?php if($value[25]!=''){echo 'checked';} ?> />
      3. ประมง</td>
      <td >        <input type="checkbox"  value="4"  id="cCareer4"    name="v26" class="cCareer" <?php if($value[26]!=''){echo 'checked';} ?> />
      4. ข้าราชการ/ลูกจ้างหรือพนักงานของรัฐ</td>
      <td >&nbsp;</td>
    </tr>
    <tr class="careertable">
      <td height="25" align="right">&nbsp;</td>
      <td >        <input type="checkbox"  value="5"  id="cCareer5"    name="v27" class="cCareer" <?php if($value[27]!=''){echo 'checked';} ?> />
      5. พนักงานรัฐวิสาหกิจ</td>
      <td >        <input type="checkbox"  value="6"  id="cCareer6"    name="v28" class="cCareer" <?php if($value[28]!=''){echo 'checked';} ?> />
      6. เจ้าหน้าที่องค์กรปกครองท้องถิ่น </td>
      <td >&nbsp;</td>
    </tr>
    <tr class="careertable">
      <td height="25" align="right">&nbsp;</td>
      <td >        <input type="checkbox"  value="7"  id="cCareer7"    name="v29" class="cCareer" <?php if($value[29]!=''){echo 'checked';} ?> />
      7. ค้าขาย/ธุรกิจส่วนตัว</td>
      <td >        <input type="checkbox"  value="8"  id="cCareer8"    name="v30" class="cCareer" <?php if($value[30]!=''){echo 'checked';} ?> />
      8. พนักงาน/ลูกจ้างเอกชน</td>
      <td >&nbsp;</td>
    </tr>
    <tr class="careertable">
      <td height="25" align="right">&nbsp;</td>
      <td width="280" >        <input type="checkbox"  value="9"  id="cCareer9"    name="v31" class="cCareer" <?php if($value[31]!=''){echo 'checked';} ?> />
      9. ว่างงาน/ไม่มีงานทำ</td>
      <td  colspan="2">
        
        <input type="checkbox"  value="10"  id="cCareer10"    name="v32" class="cCareer" <?php if($value[32]!=''){echo 'checked';} ?> />
        10. อื่น ๆ ระบุ
  <input  name="v33" type="text" value="<?php echo $value[33]; ?>" style="width:80%" id="tCareer"  /></td>
      </tr>
      <!--</div>-->
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="1"  id="rLand"    name="v34" <?php if($value[34]==1){echo 'checked';} ?>/>
        มี จำนวน 
        <input name="v35" type="text" id="tLand" size="10" class="numberOnly" value="<?php echo $value[35]; ?>" />
        ไร่</td>
      <td ><input    name="v34" type="radio" class="rLand_1"  id="m34"  value="2" <?php if($value[34]==2){echo 'checked';} ?>/>
        ไม่มี</td>
      <td >&nbsp;</td>
    </tr>
    <tr class="careertable">
      ...
      <td  colspan="3">รายได้เฉลี่ยของครอบครัว จำนวน
        <input name="v36" type="text" value="<?php echo $value[36]; ?>" size="10" id="tIncome" class="numberOnly" />
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><input name="v37" type="radio" class="rReligion"  id=""  value="1" <?php if($value[37]==1){echo 'checked';} ?>/>
        1. พุทธ
        &nbsp;
        <input type="radio"  value="2" id="" name="v37"  class="rReligion" <?php if($value[37]==2){echo 'checked';} ?>/>
        2. คริสต์
        <input type="radio"  value="3"  id="" name="v37"   class="rReligion <?php if($value[37]==3){echo 'checked';} ?>"/>
        3. อิสลาม
        &nbsp;
        <input type="radio"  value="4"  name="v37"  class="rReligion_1" id="rReligion_2" <?php if($value[37]==4){echo 'checked';} ?>/>
        4. อื่น ๆ ระบุ
        <input name="v38" type="text" value="<?php echo $value[38]; ?>" style="width:60%" id="tReligion_1" /></td>
      </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input name="v39" type="radio"  class="rStatus"  value="1" <?php if($value[39]==1){echo 'checked';} ?> />
        1. โสด</td>
      <td  colspan="2"><input type="radio"  value="2" class="rStatus" name="v39" <?php if($value[39]==2){echo 'checked';} ?> />
        2. สมรส </td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="3"  class="rStatus"  name="v39" <?php if($value[39]==3){echo 'checked';} ?>/>
        3. หย่าร้าง</td>
      <td  colspan="2"><input type="radio"  value="4" class="rStatus" name="v39" <?php if($value[39]==4){echo 'checked';} ?>/>
        4. หม้ายเนื่องจากคู่สมรสเสียชีวิต</td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="5"  id="rStatus_5" name="v39" <?php if($value[39]==5){echo 'checked';} ?> />
    ...
    <tr class="rStatus_detail">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><dd><input type="radio"  value="1" class="rStatus_5_detail" name="v40" <?php if($value[40]==1){echo 'checked';} ?> />
แยกกันอยู่ชั่วคราวตามข้อตกลงตามข้อตกลงระหว่างคู่สมรส</dd></td>
      </tr>
    <tr class="rStatus_detail">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><dd><input type="radio"  value="2" class="rStatus_5_detail" name="v40" <?php if($value[40]==2){echo 'checked';} ?>/>แยกกันอยู่ชั่วคราวตามคำสั่งศาล</dd>
        </td>
      </tr>
    ...
    <tr id="t15_detail_1">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><input  name="v41" type="radio" class="rStructureFamily" id="rStructureFamily"  value="1" <?php if($value[41]==1){echo 'checked';} ?>/>
        1. ครอบครัวเดียว จำนวนสมาชิก
<input type="text" value="<?php echo $value[42]; ?>" size="4" maxlength="4" name="v42" id="tMemberFamily_1" style="background:#EBEBE4" readonly/>
        คน ชาย
  <input type="text" value="<?php echo $value[43]; ?>" size="4" maxlength="4" name="v43" id="tMemberMale_1" class="numberOnly"/>
        คน หญิง
  <input type="text" value="<?php echo $value[44]; ?>" size="4" maxlength="4" name="v44" id="tMemberFemale_1" class="numberOnly"/>
  &nbsp;คน <strong>*ครอบครัวที่ประกอบด้วยพ่อ แม่ และลูกที่ยังไม่ได้แต่งงาน</strong></td>
    </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><input type="radio"  value="2" id="rLargeFamily" name="v41" class="rLargeFamily" <?php if($value[41]==2){echo 'checked';} ?>/>
    ...
    <tr class="r15_2">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><dd>
        <input type="radio"  value="1" id="rLargeFamily_21" name="v45" class="rLargeFamily_23" <?php if($value[45]==1){echo 'checked';} ?>  />
    ...
    <tr class="r15_2" id="t15_detail_2_1">
      ...
      <td  colspan="3"><dd> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวนสมาชิก
        <input type="text" value="<?php echo $value[46]; ?>" size="4" maxlength="4" name="v46" id="tMemberFamily_2_1" style="background:#EBEBE4" readonly/>
        คน ชาย
        <input type="text" value="<?php echo $value[47]; ?>" size="4" maxlength="4" name="v47" id="tMemberMale_2_1" class="numberOnly" />
        คน หญิง
        <input type="text" value="<?php echo $value[48]; ?>" size="4" maxlength="4" name="v48" id="tMemberFemale_2_1" class="numberOnly" />
        &nbsp;คน </dd></td>
    </tr>
    <tr class="r15_2">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><dd>
        <input type="radio"  value="2" id="rLargeFamily_22" name="v45" class="rLargeFamily_24" <?php if($value[45]==2){echo 'checked';} ?>  />
    ...
    <tr class="r15_2" id="t15_detail_2_2">
      ...
      <td  colspan="3" valign="top"><dd> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จำนวนครัวเรือน
        <input type="text" value="<?php echo $value[49]; ?>" size="4" maxlength="4" name="v49" id="v49" class="numberOnly" />
&nbsp;จำนวนสมาชิก
          <input type="text" value="<?php echo $value[50]; ?>" size="4" maxlength="4"  name="v50" id="tMemberFamily_2_2" style="background:#EBEBE4" readonly/>
        คน ชาย
        <input type="text" value="<?php echo $value[51]; ?>" size="4" maxlength="4" name="v51" id="tMemberMale_2_2" class="numberOnly" />
        คน หญิง
        <input type="text" value="<?php echo $value[52]; ?>" size="4" maxlength="4"  name="v52" id="tMemberFemale_2_2" class="numberOnly"/>
        &nbsp;คน </dd></td>
    </tr>
    
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><input type="radio"  value="3" id="rSpecialFamily"  name="v41" class="rSpecialFamily" <?php if($value[41]==3){echo 'checked';} ?>/>
    ...
    <tr class="r15_3">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><dd>
        <input type="radio"  value="1" id="rSpecialFamily_1" name="v53" class="rSpecialFamily_1" <?php if($value[53]==1){echo 'checked';} ?> />
    ...
    <tr class="r15_3">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><dd>
        <input type="radio"  value="2" id="rSpecialFamily_2" name="v53" class="rSpecialFamily_2" <?php if($value[53]==2){echo 'checked';} ?> />
    ...
    <tr class="r15_3">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><dd>
        <input type="radio"  value="3" id="rSpecialFamily_3"  name="v53" class="rSpecialFamily_3" <?php if($value[53]==3){echo 'checked';} ?> />
        3.3 ครอบครัวบุตรบุญธรรม</dd></td>
      <td >&nbsp;</td>
    </tr>
    <tr class="r15_3">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><dd><input type="radio"  value="4" id="rSpecialFamily_4"  name="v53" class="rSpecialFamily_4" <?php if($value[53]==4){echo 'checked';} ?>  />
    ...
    <tr class="r15_3">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="2"><dd><input type="radio"  value="5" id="rSpecialFamily_5"  name="v53" class="rSpecialFamily_5" <?php if($value[53]==5){echo 'checked';} ?> />
    ...
    <tr class="r15_3">
      <td height="25" align="right">&nbsp;</td>
      <td  colspan="3"><dd>
        <input type="radio"  value="6" id="rSpecialFamily_6"  name="v53" class="rSpecialFamily_6" <?php if($value[53]==6){echo 'checked';} ?> />
        3.6 อื่น ๆ ระบุ
        <input name="v54" type="text" value="<?php echo $value[54]; ?>" style="width:85%" id="tSpecialFamily_3" />
      </dd></td>
      </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td width="280" ><input name="v55" type="radio"  id="rDefective_1"  value="1" <?php if($value[55]==1){echo 'checked';} ?>  />1. ไม่มี</td>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
      </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="2"  id="rDefective_2"  name="v55" <?php if($value[55]==2){echo 'checked';} ?>/>2. จำนวน<input type="text" value="<?php echo $value[56]; ?>" size="4" maxlength="4" name="v56" id="tDefective" style="background:#EBEBE4" readonly>คน โปรดระบุ </td>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
      </tr>
      ...
      <td colspan="3"><dd>
        <table>
          <tr>
            ...
            <td><input type="text" value="<?php echo $value[57]; ?>" size="4" maxlength="4" name="v57" id="tChild" class="numberOnly" />
              คน</td>
            </tr>
          <tr>
            <td>จำนวนผู้พิการ</td>
            <td><input type="text" value="<?php echo $value[58]; ?>" size="4" maxlength="4"  name="v58" id="tDisabled" class="numberOnly" />
              คน</td>
            </tr>
          <tr>
            <td>จำนวนผู้ป่วยทางจิต</td>
            <td><input type="text" value="<?php echo $value[59]; ?>" size="4" maxlength="4" name="v59" id="tMindSick" class="numberOnly" />
              คน</td>
            </tr>
          <tr>
            <td>จำนวนผู้ป่วยเรื้อรัง</td>
            <td><input type="text" value="<?php echo $value[60]; ?>" size="4" maxlength="4"  name="v60" id="tSick" class="numberOnly"/>
              คน</td>
            </tr>
          <tr>
            <td>จำนวนผู้สูงอายุ</td>
            <td><input type="text" value="<?php echo $value[61]; ?>" size="4" maxlength="4" name="v61" id="tElderly" class="numberOnly" />
              คน</td>
            </tr>
          </table>
    ...
    <tr>
      ...
      <td colspan="3"><table width="50%" border="0" cellpadding="1" cellspacing="0" id="t17">
        ...
        <tr>
          ...
          <td width="202"  align="center"><input  name="v62" type="text" id="tChildMale"  style=" width:80%" maxlength="4" value="<?php echo $value[62]; ?>"/></td>
          <td width="202"  align="center"><input name="v63" type="text" id="tChildFemale"  style=" width:80%" maxlength="4" value="<?php echo $value[63]; ?>" /></td>
          <td  align="center"><input name="v64" type="text" id="tChildTotal"  style=" width:80%; background:#CCC;" value="<?php echo $value[64]; ?>" maxlength="4" readonly /></td>
          </tr>
        <tr>
          <td width="184" height="25"  align="left">&nbsp;2. เยาวชน (อายุ 19-25 ปี)</td>
          <td width="202"  align="center"><input name="v65" type="text" id="tTeensMale"  style=" width:80%" maxlength="4" value="<?php echo $value[65]; ?>"  /></td>
          <td width="202"  align="center"><input name="v66" type="text" id="tTeensFemale"  style=" width:80%" maxlength="4" value="<?php echo $value[66]; ?>" /></td>
          <td  align="center"><input name="v67" type="text" id="tTeensTotal"  style=" width:80%; background:#CCC;" value="<?php echo $value[67]; ?>" maxlength="4" readonly /></td>
          </tr>
        <tr>
          <td width="184" height="25"  align="left">&nbsp;3. ผู้อาศัยทั่วไป (อายุ 26-59 ปี)</td>
          <td width="202"  align="center"><input name="v68" type="text" id="tMan"  style=" width:80%" maxlength="4" value="<?php echo $value[68]; ?>" /></td>
          <td width="202"  align="center"><input name="v69" type="text" id="tWoman"  style=" width:80%" maxlength="4" value="<?php echo $value[69]; ?>" /></td>
          <td  align="center"><input name="v70" type="text" id="tTotal"  style=" width:80%;background:#CCC;" value="<?php echo $value[70]; ?>" maxlength="4" readonly /></td>
          </tr>
        <tr>
          <td width="184" height="25"  align="left">&nbsp;4. ผู้สูงอายุ (อายุ 60 ปี)</td>
          <td width="202"  align="center"><input name="v71" type="text" id="tElderMale"  style=" width:80%" maxlength="4" value="<?php echo $value[71]; ?>" /></td>
          <td width="202"  align="center"><input name="v72" type="text" id="tElderFemale"  style=" width:80%" maxlength="4" value="<?php echo $value[72]; ?>" /></td>
          <td  align="center"><input name="v73" type="text" id="tElderTotal"  style=" width:80%;background:#CCC;" value="<?php echo $value[73]; ?>" maxlength="4" readonly /></td>
          </tr>
        <tr>
          <td width="184" height="25"  align="left">&nbsp;5. คนพิการ</td>
          <td width="202"  align="center"><input name="v74" type="text" id="tDisabledMale"  style=" width:80%" maxlength="4" value="<?php echo $value[74]; ?>" /></td>
          <td width="202"  align="center"><input name="v75" type="text" id="tDisabledFemale"  style=" width:80%" maxlength="4" <?php echo $value[75]; ?>  /></td>
          <td  align="center"><input name="v76" type="text" id="tDisabledTotal"  style=" width:80%;background:#CCC;" value="<?php echo $value[76]; ?>" maxlength="4" readonly  /></td>
          </tr>
        <tr>
          <td width="184" height="25"  align="center">รวมทั้งสิ้น</td>
          <td width="202"  align="center"><input name="v77" type="text" id="tMaleTotal"  style=" width:80%;background:#CCC;" value="<?php echo $value[77]; ?>" maxlength="4" readonly   /></td>
          <td width="202"  align="center"><input name="v78" type="text" id="tFemaleTotal"  style=" width:80%;background:#CCC;" value="<?php echo $value[78]; ?>" maxlength="4" readonly /></td>
          <td  align="center"><input name="v79" type="text" id="tSumTotal"  style=" width:80%;background:#CCC;" value="<?php echo $value[79]; ?>" maxlength="4" readonly /></td>
          </tr>
        </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td  valign="top"><input   name="v80" type="radio"  id="rDebt_1"  value="1" <?php if($value[80]==1){echo 'checked';} ?>/> 1. ไม่มี</td>
      <td  valign="top"><br></td>
      <td >&nbsp;</td>
    </tr>
    <tr>
      <td height="25" align="right">&nbsp;</td>
      <td ><input type="radio"  value="2"  id="rDebt_2" name="v80" <?php if($value[80]==2){echo 'checked';} ?> /> 2. มี โปรดระบุ</td>
      <td >&nbsp;</td>
      <td >&nbsp;</td>
    </tr>
    <tr class="t18">
      <td height="25" align="right">&nbsp;</td>
      <td >&nbsp;&nbsp;&nbsp;&nbsp;
<input type="checkbox"  value="1"  id="rDebt_a" name="v379" <?php if($value[379]==1){echo 'checked';} ?> /> 
        2.1 หนี้ในระบบ</td>
      <td  colspan="2">&nbsp;</td>
    </tr>
    <tr id="t18_a" class="t18">
      ...
      <table width="809" border="0" cellpadding="1" cellspacing="1" class="t21">
        <tr>
          <td width="20"><input name="v81" type="checkbox" id="2_2_1" value="1" <?php if($value[81]==1){echo 'checked';} ?>></td>
          <td>เงินกู้ธนาคาร</td>
          </tr>
        <tr id="t18_2_1_1">
          <td>&nbsp;</td>
          <td>จำนวน 
            <input type="text" value="<?php echo $value[82]; ?>" size="10" name="v82" id="t21_money_1"  />
            บาท ดอกเบี้ยร้อยละ            
            <input type="text" value="<?php echo $value[83]; ?>" size="10" name="v83" id="t21_interest_1"/>
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[84]; ?>" size="10" name="v84" id="t21_pay_1"/>
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[85]; ?>" size="10" name="v85" id="t21_balance_1" />
            บาท</td>
          </tr>
        <tr>
          <td><input name="v86" type="checkbox" value="2" id="2_2_2" <?php if($value[86]==2){echo 'checked';} ?>></td>
          <td>เงินกู้กองทุนสัจจะสะสมทรัพย์</td>
          </tr>
        <tr id="t18_2_1_2">
          <td>&nbsp;</td>
          <td>จำนวน
            <input type="text" value="<?php echo $value[87]; ?>" size="10" name="v87" id="t21_money_2" />
บาท ดอกเบี้ยร้อยละ 
<input type="text" value="<?php echo $value[88]; ?>" size="10" name="v88" id="t21_interest_2" />
ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[89]; ?>" size="10" name="v89" id="t21_pay_2" />
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[90]; ?>" size="10" name="v90" id="t21_balance_2" />
            บาท</td>
          </tr>
        <tr>
          <td><input name="v91" type="checkbox" id="2_2_3" value="3" <?php if($value[91]==3){echo 'checked';} ?>></td>
          <td>เงินกู้กองทุนหมู่บ้าน</td>
          </tr>
        <tr id="t18_2_1_3">
          <td>&nbsp;</td>
          <td>จำนวน 
            <input type="text" value="<?php echo $value[92]; ?>" size="10" name="v92" id="t21_money_3"/>
บาท ดอกเบี้ยร้อยละ <input type="text" value="<?php echo $value[93]; ?>" size="10" name="v93" id="t21_interest_3" />
ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน
<input type="text" value="<?php echo $value[94]; ?>" size="10" name="v94" id="t21_pay_3" />
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[95]; ?>" size="10" name="v95" id="t21_balance_3" />
            บาท</td>
          </tr>
        <tr >
          <td><input name="v96" type="checkbox" id="2_2_4" value="4" <?php if($value[96]==4){echo 'checked';} ?>></td>
          <td>กองทุนพัฒนาบทบาทสตรี</td>
          </tr>
        <tr id="t18_2_1_4">
          <td>&nbsp;</td>
          <td>จำนวน 
            <input type="text" value="<?php echo $value[97]; ?>" size="10" name="v97" id="t21_money_4" />
            บาท ดอกเบี้ยร้อยละ 
            <input type="text" value="<?php echo $value[98]; ?>" size="10" name="v98" id="t21_interest_4" />
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[99]; ?>" size="10" name="v99" id="t21_pay_4" />
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[100]; ?>" size="10" name="v100" id="t21_balance_4" />
            บาท</td>
          </tr>
        <tr>
          <td><input name="v101" type="checkbox" id="2_2_5" value="5" <?php if($value[101]==5){echo 'checked';} ?>></td>
          <td>กองทุนผู้สูงอายุ</td>
          </tr>
        <tr id="t18_2_1_5">
          <td>&nbsp;</td>
          <td>จำนวน 
            <input type="text" value="<?php echo $value[102]; ?>" size="10" name="v102" id="t21_money_5" />
            บาท ดอกเบี้ยร้อยละ 
            <input type="text" value="<?php echo $value[103]; ?>" size="10" name="v103" id="t21_interest_5" />
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[104]; ?>" size="10" name="v104" id="t21_pay_5" />
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[105]; ?>" size="10" name="v105" id="t21_balance_5" />
            บาท</td>
          </tr>
        <tr>
          <td><input name="v106" type="checkbox" id="2_2_6" value="6" <?php if($value[106]==6){echo 'checked';} ?>></td>
          <td>กองทุนส่งเสริมพัฒนาคุณภาพชีวิตคนพิการ</td>
          </tr>
        <tr id="t18_2_1_6">
          <td>&nbsp;</td>
          <td>จำนวน 
            <input type="text" value="<?php echo $value[107]; ?>" size="10" name="v107" id="t21_money_6"/>
            บาท ดอกเบี้ยร้อยละ 
            <input type="text" value="<?php echo $value[108]; ?>" size="10" name="v108" id="t21_interest_6"/>
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[109]; ?>" size="10" name="v109" id="t21_pay_6"/>
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[110]; ?>" size="10" name="v110" id="t21_balance_6"/>
            บาท</td>
          </tr>
        <tr>
          <td><input name="v111" type="checkbox" id="2_2_7" value="7" <?php if($value[111]==7){echo 'checked';} ?>></td>
          <td>กองทุนปุ๋ย</td>
          </tr>
        <tr id="t18_2_1_7">
          <td>&nbsp;</td>
          <td>จำนวน
            <input type="text" value="<?php echo $value[112]; ?>" size="10" name="v112" id="t21_money_7"/>
            บาท ดอกเบี้ยร้อยละ 
            <input type="text" value="<?php echo $value[113]; ?>" size="10" name="v113" id="t21_interest_7" />
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[114]; ?>" size="10" name="v114" id="t21_pay_7" />
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[115]; ?>" size="10" name="v115" id="t21_balance_7" />
            บาท</td>
          </tr>
        <tr>
          <td><input name="v116" type="checkbox" id="2_2_8" value="8" <?php if($value[116]==8){echo 'checked';} ?>></td>
          <td>กองทุนเกษตร</td>
          </tr>
        <tr id="t18_2_1_8">
          <td>&nbsp;</td>
          <td>จำนวน
            <input type="text" value="<?php echo $value[117]; ?>" size="10" name="v117" id="t21_money_8" />
            บาท ดอกเบี้ยร้อยละ 
            <input type="text" value="<?php echo $value[118]; ?>" size="10" name="v118" id="t21_interest_8"/>
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[119]; ?>" size="10" name="v119" id="t21_pay_8"/>
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[120]; ?>" size="10" name="v120" id="t21_balance_8"/>
            บาท</td>
          </tr>
        <tr>
          <td><input name="v121" type="checkbox" id="2_2_9" value="9" <?php if($value[121]==9){echo 'checked';} ?>></td>
          <td>อื่น ๆ ระบุ
            <input type="text" value="<?php echo $value[122]; ?>"  style="width:84%" name="v122" id="t21_other" /></td>
          </tr>
        <tr id="t18_2_1_9">
          <td>&nbsp;</td>
          <td>จำนวน 
            <input type="text" value="<?php echo $value[123]; ?>" size="10" name="v123" id="t21_money_9"/>
            บาท ดอกเบี้ยร้อยละ 
            <input type="text" value="<?php echo $value[124]; ?>" size="10" name="v124" id="t21_interest_9"/>
            ต่อ/ปี ส่งมาแล้วเป็นเงินจำนวน 
            <input type="text" value="<?php echo $value[125]; ?>" size="10" name="v125" id="t21_pay_9"/>
            บาท ยอดคงเหลือ
            <input type="text" value="<?php echo $value[126]; ?>" size="10" name="v126" id="t21_balance_9"/>
            บาท</td>
          </tr>
      </table>
    ...
    <tr class="t18">
      <td height="25" align="right" >&nbsp;</td>
      <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;
<input  name="v380" type="checkbox" id="v380"  value="2" <?php if($value[380]==2){echo 'checked';} ?>  />
    ...
    <tr class="t18">
      ...
      <tbody>
        ...
        <tr>
          <td >ชื่อ-สกุล 
            <input type="text" name="v127" value="<?php echo $value[127]; ?>" /></td>
          <td width="104" >จำนวนเงิน</td>
          <td width="114"><input type="text" name="v128" size="10" value="<?php echo $value[128]; ?>" />
บาท</td>
          <td width="104">ดอกเบี้ยร้อยละ</td>
          <td width="264"><input name="v129" type="text" value="<?php echo $value[129]; ?>" size="10" />
ต่อวัน/เดือน/ปี </td>
          </tr>
        <tr>
          <td width="191" >&nbsp;</td>
          <td >ส่งมาแล้วเป็นเงิน            </td>
          <td ><input name="v130" type="text" value="<?php echo $value[130]; ?>" size="10" />
บาท</td>
          <td >ยอดคงเหลือ</td>
          <td ><input name="v131" type="text" value="<?php echo $value[131]; ?>" size="10" />
บาท</td>
          </tr>
        <tr>
          <td >ชื่อ-สกุล
            <input type="text" name="v132" value="<?php echo $value[132]; ?>" /></td>
          <td >จำนวนเงิน</td>
          <td ><input type="text" name="v133" size="10" value="<?php echo $value[133]; ?>" />
บาท</td>
          <td >ดอกเบี้ยร้อยละ</td>
          <td ><input name="v134" type="text" value="<?php echo $value[134]; ?>" size="10" />
ต่อวัน/เดือน/ปี </td>
          </tr>
        <tr>
          <td >&nbsp;</td>
          <td >ส่งมาแล้วเป็นเงิน</td>
          <td ><input name="v135" type="text" value="<?php echo $value[135]; ?>" size="10" />
บาท</td>
          <td >ยอดคงเหลือ</td>
          <td ><input name="v136" type="text" value="<?php echo $value[136]; ?>" size="10" />
บาท</td>
        </tr>
        <tr>
          <td >ชื่อ-สกุล
            <input type="text" name="v137" value="<?php echo $value[137]; ?>" /></td>
          <td>จำนวนเงิน</td>
          <td ><input type="text" name="v138" size="10" value="<?php echo $value[138]; ?>" />
            บาท</td>
          <td>ดอกเบี้ยร้อยละ</td>
          <td ><input name="v139" type="text" value="<?php echo $value[139]; ?>" size="10" />
            ต่อวัน/เดือน/ปี </td>
        </tr>
        <tr>
          <td >&nbsp;</td>
          <td>ส่งมาแล้วเป็นเงิน</td>
          <td ><input name="v140" type="text" value="<?php echo $value[140]; ?>" size="10" />
            บาท</td>
          <td>ยอดคงเหลือ</td>
          <td ><input name="v141" type="text" value="<?php echo $value[141]; ?>" size="10" />
            บาท</td>
        </tr>
        <tr>
          <td >ชื่อ-สกุล            <input type="text" name="v142" value="<?php echo $value[142]; ?>" /></td>
          <td>จำนวนเงิน</td>
          <td ><input type="text" name="v143" size="10" value="<?php echo $value[143]; ?>" />
            บาท</td>
          <td>ดอกเบี้ยร้อยละ</td>
          <td ><input name="v144" type="text" value="<?php echo $value[144]; ?>" size="10" />
            ต่อวัน/เดือน/ปี </td>
        </tr>
        <tr>
          <td >&nbsp;</td>
          <td>ส่งมาแล้วเป็นเงิน</td>
          <td ><input name="v145" type="text" value="<?php echo $value[145]; ?>" size="10" />
            บาท</td>
          <td>ยอดคงเหลือ</td>
          <td ><input name="v146" type="text" value="<?php echo $value[146]; ?>" size="10" />
            บาท</td>
        </tr>
        <tr>
          <td >ชื่อ-สกุล            <input type="text" name="v147" value="<?php echo $value[147]; ?>" /></td>
          <td>จำนวนเงิน</td>
          <td ><input type="text" name="v148" size="10" value="<?php echo $value[148]; ?>" />
            บาท</td>
          <td>ดอกเบี้ยร้อยละ</td>
          <td ><input name="v149" type="text" value="<?php echo $value[149]; ?>" size="10" />
            ต่อวัน/เดือน/ปี </td>
        </tr>
        <tr>
          <td >&nbsp;</td>
          <td>ส่งมาแล้วเป็นเงิน</td>
          <td ><input name="v150" type="text" value="<?php echo $value[150]; ?>" size="10" />
            บาท</td>
          <td>ยอดคงเหลือ</td>
          <td ><input name="v151" type="text" value="<?php echo $value[151]; ?>" size="10" />
            บาท</td>
        </tr>
        </tfoot>
      </table>
